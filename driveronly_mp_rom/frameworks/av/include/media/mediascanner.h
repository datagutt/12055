...
struct MediaScanner {
    ...
    void setAudioFileNameRegion(const char *audioFileNameRegion);
    #endif /* VENDOR_EDIT */
...
protected:
    ...
    //property=android.annotation.OppoHook.OppoRomType.OPPO
    //Yugang.Ma@Exp.MultiMedia add for ID3 support of different countries 2013/08/26
    const char *getAudioFileNameRegion() const;
    #endif /* VENDOR_EDIT */
private:
...
protected:
    ...
    //property=android.annotation.OppoHook.OppoRomType.OPPO
    //Yugang.Ma@Exp.MultiMedia add for ID3 support of different countries 2013/08/26
    uint32_t        mAudioFileNameRegionEncoding;
    #endif /* VENDOR_EDIT */
};
