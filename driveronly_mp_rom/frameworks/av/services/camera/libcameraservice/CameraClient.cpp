...
#ifndef VENDOR_EDIT
//LiChen@CameraApp, 2013/03/08, Modify for IntelligentSleep
/*
...
*/
#else /* VENDOR_EDIT */
    if (callingPid != mClientPid && callingPid != mServicePid && getIntellgetCameraId() != CAMERA_INTELLIGENT_SLEEP) {
        ALOGW("different client - don't disconnect");
        return;
    }
#endif /* VENDOR_EDIT */
...
/*zoujianmin@CameraService*/
#ifdef VENDOR_EDIT
    int shutterSound = p.getInt("shutter-sound");
    LOG1("setParameters, shutter-sound: %d", shutterSound);
