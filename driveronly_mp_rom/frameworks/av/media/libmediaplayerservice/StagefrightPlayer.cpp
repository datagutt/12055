...
#ifdef VENDOR_EDIT
//Xianfen.Fu@Prd.Video.VideoCodec,2012/06/21,Add for captureFrame
status_t StagefrightPlayer::captureFrame(const String8& params) {
    ALOGV("captureFrame(%s)", params.string());
    return mPlayer->captureFrame(params);
}
#endif /* VENDOR_EDIT */
