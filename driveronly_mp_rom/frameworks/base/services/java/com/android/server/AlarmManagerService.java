...
class AlarmManagerService extends IAlarmManager.Stub {
    ...
    public AlarmManagerService(Context context) {
    	...
    	//#ifndef VENDOR_EDIT
    	//Yuanliu.Tang@PersonalA.Alarm, 2013/02/22, Modify for starting oppo alarm clock
    	/*
    	mAlarmIconPackageList.add("com.android.deskclock");
    	*/
    	//#else /* VENDOR_EDIT */
        mAlarmIconPackageList.add(AlarmManager.ALARM_PACKAGE_NAME);
    	//#endif /* VENDOR_EDIT */
        // /M:add for DM feature ,@{
                ...
                public void onReceive(Context context, Intent intent) {
                    if ("android.intent.action.ACTION_SHUTDOWN".equals(intent.getAction())
                            || "android.intent.action.ACTION_SHUTDOWN_IPO".equals(intent
                                    .getAction())) {
					//#ifdef VENDOR_EDIT
                      //Qihu.Liu@PersonalApp.Clock.Alarm, 2012/02/18, Modify for [ALPS00235976], {
                      /*
                      ...
                      */
                      ...
                      synchronized (mPowerOffAlarmLock) {
                          shutdownCheckPoweroffAlarm();
                          //Yatao.Yang@PersonalApp.Clock.Alarm, 2012/02/27, Add for clear the map when shutdown {
                          mPoweroffAlarmMap.clear();
                          //} add end
                          
                      }                          
                      //} modify end for [ALPS00235976].
		...
		//#ifdef VENDOR_EDIT
		//#@OppoHook
        //Jun.Zhang@Plf.Framework, ZhiYong.Lin@Plf.Framework, OppoAlarmManagerHelper init 2013/02/18
        OppoAlarmManagerHelper.init(context);
		//#endif /* VENDOR_EDIT */
    }
    ...
    public void setRepeating(int type, long triggerAtTime, long interval, 
        ...
        //#ifdef VENDOR_EDIT
		//#@OppoHook
        //ZhiYong.Lin@Plf.Framework, 2013/04/16, add for align alarm time
        long modifyTriggerAtTime = OppoAlarmManagerHelper.alignTriggerTime(type, triggerAtTime, operation);
        long modifyInterval = OppoAlarmManagerHelper.alignInterval(type, interval, operation);
        //#endif /* VENDOR_EDIT */
        ...
        synchronized (mLock) {
            ...
            */
            //#else VENDOR_EDIT
            alarm.when = modifyTriggerAtTime;
            alarm.repeatInterval = modifyInterval;
            //#endif /* VENDOR_EDIT */
            ...
            synchronized (mLock) {
                ...
                if (Intent.ACTION_QUERY_PACKAGE_RESTART.equals(action)) {
                    ...
                    if (data != null) {
                        ...
                        //#ifndef VENDOR_EDIT
						//#@OppoHook
                        //Jun.Zhang@Plf.Framework, 2013/02/18, modify for filter package
						/*
                        if (pkg != null) {
                        */
                        //#else
                        if (pkg != null && !OppoAlarmManagerHelper.isFilterRemovePackage(pkg)) { //remove pkg in filter
                        //#endif /* VENDOR_EDIT */
    ...
    //#ifdef VENDOR_EDIT
    //Qihu.Liu@PersonalApp.Clock.Alarm, 2012/02/03, Add for [Power_off_alarm_feature]
    ...
    //#endif /* VENDOR_EDIT */
        ...
        synchronized (mPowerOffAlarmLock) {
            ...
            while (it.hasNext()) {
                ...
                //#ifdef VENDOR_EDIT
                //Qihu.Liu@PersonalApp.Clock.Alarm, 2012/02/03, Add for [Power_off_alarm_feature]
    		      if (!tempName.equals(targetPackage)) {
    		          continue;
    		      }                    
                //#endif /* VENDOR_EDIT */
    ...
    private void resetPoweroffAlarm() {
        ...
        long latestTime;
        //#ifdef VENDOR_EDIT
        //Yatao.Yang@PersonalApp.Clock.Alarm, 2012/03/03, Add for get current time    	
        long nowTime = System.currentTimeMillis();
        //#endif /* VENDOR_EDIT */ 
        if (it.hasNext()) {
            String tempName = it.next();
        ...
        while (it.hasNext()) {
            ...
            //#ifdef VENDOR_EDIT
            //Yatao.Yang@PersonalApp.Clock.Alarm, 2012/03/03, Add for if alarm has expire,just ignore
            if (tempTime < nowTime) { 
                continue; 
            } 
            ...
            if (tempTime <= latestTime) {
                if (tempTime == latestTime) {
        				//#ifndef VENDOR_EDIT
        				////Yuanliu.Tang@Prd.CommonApp.AlarmClock, 2012/6/21, Modify for oppo alarm clock
        				/*
        				if (setPackageName.equals("com.android.deskclock")) {
        				      */
        				//#else /* VENDOR_EDIT */
    					if (setPackageName.equals(AlarmManager.ALARM_PACKAGE_NAME)) {       				    
        				//#endif /* VENDOR_EDIT */
                        continue;
                    }
                }
	    ...
	    //#ifdef VENDOR_EDIT
		//Wuheng@PlatformSrv, 2013/2/21, port for Alarm upgrade android4.2
	    /*
        if (setPackageName.equals("com.android.deskclock")) {
	    */
	        if (setPackageName.equals(AlarmManager.ALARM_PACKAGE_NAME)) {
	    //#endif /* VENDOR_EDIT */
            ...
            set(mDescriptor, 7, latestTime / 1000, (latestTime % 1000) * 1000 * 1000);
        //#ifdef VENDOR_EDIT
        //LiuMing@Prd.SysApp.Settings, 2013/03/08, Add for [oppo timepower]
        } else if (setPackageName.equals("com.android.settings")) {
            Slog.i(TAG, "mBootPackage = " + setPackageName + " set Prop 2");
            SystemProperties.set("persist.sys.bootpackage", "2"); // for
                                                                  // settings
            set(mDescriptor, 7, latestTime / 1000, (latestTime % 1000) * 1000 * 1000);
    ...
    public void cancelPoweroffAlarm(String name) {
        ...
        if (bootPackage != null) {
            if (bootPackage.equals(name)) {
        		...
        		*/
        		//#else /* VENDOR_EDIT */
    			if (bootPackage.equals(AlarmManager.ALARM_PACKAGE_NAME)) {       				    
        		//#endif /* VENDOR_EDIT */
                ...
                //#ifdef VENDOR_EDIT
                //LiuMing@Prd.SysApp.Settings, 2013/03/08, Add for [oppo timepower]
                } else if (bootPackage.equals("com.android.settings")) {
                    set(mDescriptor, 7, 0, 0);
                //#endif /* VENDOR_EDIT */
                }
    ...
    //#ifndef VENDOR_EDIT
    //Yatao.Yang@Prd.DesktopApp.Launcher, 2012/09/11, Modify for mPoweroffAlarmMap has more than one record
    /*
    	...
    	if (it.hasNext()) {            
    		...
    		if ((latestTime - 30*1000) <= nowTime ){
                   ...
                   while (italarm.hasNext()) {
                       ...
                       if (alarm.operation.getTargetPackage().equals(setPackageName) && alarm.when == latestTime) {
    ...
    */
    ...
    private void shutdownCheckPoweroffAlarm() {  
    	...
    	long latestTime;
        long nowTime = System.currentTimeMillis();
    	outLoop: while (it.hasNext()) {            
    		String tempName = it.next();
    		latestTime = mPoweroffAlarmMap.get(tempName).mTriggerTime;
    		setPackageName = tempName;
    		Slog.i(TAG,"setPackageName = " + setPackageName);  
    		if ((latestTime - 30*1000) <= nowTime ){
		           Slog.i(TAG,"get target latestTime < 30S!!");    		
                   Iterator<Alarm> italarm = mRtcWakeupAlarms.iterator();
                   while (italarm.hasNext()) {
	...
	//#ifdef VENDOR_EDIT 
	//Yuanliu.Tang@PlatformSrv.Alarm, 2012/02/14, Add for for SecureSafe remove alarms by packages 20120129
    public void removePackagesAlarms(String[] pkgList) {
        synchronized (mLock) {
            if (pkgList != null && (pkgList.length > 0)) {
                for (String pkg : pkgList) {
                    Slog.w(TAG, "removePackagesAlarms:" + pkg);
                    removeLocked(pkg);
                    mBroadcastStats.remove(pkg);
                }
            }
