...
class ScreenRotationAnimation {
    ...
    public boolean dismiss(SurfaceSession session, long maxAnimationDuration,
     ...
     //Kaiyu.Zhong@Prd.MidWare.WMS,2012/08/09,Add for screen_effect state
		if (!mScreenEffectState){
			Slog.d(TAG,"!mScreenEffectState!");
			kill();
			return false;
		}
     //#endif   /* VENDOR_EDIT */
...
//#ifdef VENDOR_EDIT
//Kaiyu.Zhong@Prd.MidWare.WMS,2012/08/09,Add for screen_effect state
	private boolean mScreenEffectState = true;
	public void setMode(boolean screenEffectState){
		mScreenEffectState = screenEffectState;
	}
//#endif /* VENDOR_EDIT */
}
