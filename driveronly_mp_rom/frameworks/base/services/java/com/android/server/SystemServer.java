...
/// @}
//#ifdef VENDOR_EDIT
//ZhenHai.Long@Prd.SysSRV, 2012/10/24, add for init OppoUtils obj
import android.oppoutils.OppoUtils;
//#endif /*VENDOR_EDIT*/
//#ifdef VENDOR_EDIT
//moqingping@Prd.SysAPP.SecureMgr, 2013/04/08, Add for new feature for  settings->show-> color set preference
import com.oppo.tpreset.tpreset; 

//#ifdef VENDOR_EDIT
//#@OppoHook
//TongXi.Li@Plf.Framework, 2012/10/24, add for oppo_usb
import com.android.server.usb.OppoUsbService;
//#endif /* VENDOR_EDIT */
//#ifdef VENDOR_EDIT
//#@OppoHook 
//Jun.Zhang@Plf.Framework, add for oppo ex service, view vibrate when play Sound Effect.
import android.os.OppoExManager;
import com.android.server.oppo.OppoExService;
import com.android.server.OppoVibratorService;
//#endif /* VENDOR_EDIT */
...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        try {
			...
			//#ifndef VENDOR_EDIT
			//#@OppoHook
			//Jun.Zhang@Plf.Framework.Power, 2012/12/26, Modify for use oppo button light
			/*
            /*lights = new LightsService(context);
			*/
			//#else /* VENDOR_EDIT */
			lights = new OppoLightsService(context);
			//#endif /* VENDOR_EDIT */
			...
			//#ifndef VENDOR_EDIT
			//#@OppoHook
			//Jun.Zhang@Plf.Framework.Power, 2013/08/21, Modify for view vibrate when play Sound Effect
			/*
            /*vibrator = new VibratorService(context);
			*/
			//#else /* VENDOR_EDIT */
			vibrator = new OppoVibratorService(context);
			//#endif /* VENDOR_EDIT */
            ...
            if (SystemProperties.get("ro.kernel.qemu").equals("1")) {
                ...
                */
                ...
                //#ifndef VENDOR_EDIT
                //wenjie.Liu@Prd.SysApp.PowerManager, 2013/03/19, Modify for :
                /*
                if (bluetoothOn != 0) {
                    bluetooth.enable();
	                }
...
//#ifndef VENDOR_EDIT
		//zhiyong.lin@Plf.Framework.PMS, add for upgrade android4.1 2012-09-22
        ...
        Slog.w(TAG, "update dialogue has been removed");
//#endif /* VENDOR_EDIT */
        ...
        //#ifndef VENDOR_EDIT
        //moqingping@Prd.SysAPP.SecureMgr, 2013/04/07, Remove for the profielservice caused the default ringtone when shutdown really
        /*
        /// M: Add AudioProfile service @{
        ...
        */
        //#endif /* VENDOR_EDIT */
            ...
            try {
                ...
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //TongXi.Li@Plf.Framework, 2012/10/24, Modify for oppo_usb
                /*
		        usb = new UsbService(context);
		        */							
                //#else /* VENDOR_EDIT */
                usb = new OppoUsbService(context);
                //#endif /* VENDOR_EDIT */
			...
			//#ifdef VENDOR_EDIT
			//#@OppoHook 
			//Jun.Zhang@Plf.Framework, for start oppo ex service, three pointers move shot screen.
            try {
                Slog.i(TAG, "Oppo Expand Service");
                OppoExService oppoExService = new OppoExService(context, wm);
                ServiceManager.addService(OppoExManager.SERVICE_NAME, oppoExService);
            } catch (Throwable e) {
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                //#ifdef VENDOR_EDIT
                //moqingping@Prd.SysAPP.SecureMgr, 2013/04/08, Add for 12083 feature : color set in settings'display tab
                String productNameProject = SystemProperties.get("ro.product.name", "oppo");
                if (productNameProject.equals("OPPO89T_12083")) {
                    int valueset = Settings.System.getInt(mContentResolver,Settings.System.OPPO_SCREAN_COLOR_DEFINE ,1);    
                    try{
                        tpreset.oppo_lcd_display_change(valueset);
                    }catch(Throwable e){
                        Slog.i(TAG, "oppo lcd display change error!");    
                    }   
                }
                //#endif /* VENDOR_EDIT */
