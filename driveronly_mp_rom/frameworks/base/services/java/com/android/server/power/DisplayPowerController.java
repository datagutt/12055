...
//#ifdef VENDOR_EDIT
//Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/18, Add for 
...
final class DisplayPowerController {
    ...
    */
    //#else /* VENDOR_EDIT */
    private static final int ELECTRON_BEAM_OFF_ANIMATION_DURATION_MILLIS = 200;
    //#endif /* VENDOR_EDIT */
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/04/28, Add for 
    private static final int MSG_LIGHT_SENSOR_CHANGED = 4;
    //#endif /* VENDOR_EDIT */
    ...
    */
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/18, Add for 
    public static final String SCREEN_OFF_BEGIN = "oppo.intent.action.SCREEN_OFF_BEFORE_ANIMATOR";
    //#endif /* VENDOR_EDIT */
    ...
    public DisplayPowerController(Looper looper, Context context, Notifier notifier,
        ...
        if (mUseSoftwareAutoBrightnessConfig) {
            ...
            */
            //#else /* VENDOR_EDIT */
            int[] lux = resources.getIntArray(
                    com.android.internal.R.array.oppo_config_autoBrightnessLevels);
            int[] screenBrightness = resources.getIntArray(
                    com.android.internal.R.array.oppo_config_autoBrightnessLcdBacklightValues);
            //#endif /* VENDOR_EDIT */
    ...
    private static Spline createAutoBrightnessSpline(int[] lux, int[] brightness) {
        try {
            ...
            for (int i = 1; i < n; i++) {
                x[i] = lux[i - 1];
                //#ifndef VENDOR_EDIT
                //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/04/28, Modify for 
                /*
                y[i] = normalizeAbsoluteBrightness(brightness[i]);
                */
                //#else /* VENDOR_EDIT */
                y[i] = normalizeAbsoluteBrightness(brightness[i - 1]);
                //#endif /* VENDOR_EDIT */
            }
    ...
    //#ifdef VENDOR_EDIT
    //JianRong.Zheng@BasicSrv.BatteryManager, 2013/05/24, Add for 
    ...
    public boolean requestPowerState(DisplayPowerRequest request,
        ...
        //#ifndef VENDOR_EDIT
        //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/04/22, Remove for 
        /*
        if (DEBUG) {
    ...
    private void updatePowerState() {
        ...
        //#ifndef VENDOR_EDIT
        //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/04/13, Modify for 
        /*
        if (mProximitySensor != null) {
            if (DEBUG) {
        ...
        */
        ...
        //#ifndef VENDOR_EDIT
        //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/28, Modify for 
        /*
        if (!mScreenOffBecauseOfProximity) {
        */
        //#else /* VENDOR_EDIT */
        if (true || !mScreenOffBecauseOfProximity) {
        //#endif /* VENDOR_EDIT */
                ...
                if (!mElectronBeamOnAnimator.isStarted()) {
                    if (!mElectronBeamOffAnimator.isStarted()) {
                        if (mPowerState.getElectronBeamLevel() == 0.0f || mShutDownFlag_D) {
                            ...
                            //#ifdef VENDOR_EDIT
                            //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/18, Add for video player
                            Intent mBeginScreenOffIntent = new Intent(SCREEN_OFF_BEGIN);
                            mContext.sendBroadcastAsUser(mBeginScreenOffIntent, UserHandle.ALL);
                            //#endif /* VENDOR_EDIT */
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/25, Add for 
    public void setSyncPendingProximity(boolean positive) {
        if (DEBUG) {
            Slog.d(TAG, "setSyncPendingProximity = " + positive);
        }
    ...
    private void sendProximityEvent() {
        // Apply the proximity sensor.
        if (mProximitySensor != null && mPowerRequest.useProximitySensor) {
            if (mProximity == PROXIMITY_POSITIVE) {
                sendOnProximityPositive();
            } else if (mProximity == PROXIMITY_NEGATIVE) {
                sendOnProximityNegative();
            }
        }
    }
    ...
    private void updateAutoBrightness(boolean sendUpdate) {
        ...
        if (mScreenAutoBrightness != newScreenAutoBrightness) {
            if (DEBUG) {
                //#ifndef VENDOR_EDIT
                //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/20, Modify for 
                /*
                ...
                */
                ...
                Slog.d(TAG, "updateAutoBrightness: mScreenAutoBrightness="
                        + mScreenAutoBrightness + ", newScreenAutoBrightness="
                        + newScreenAutoBrightness + ", mLastObservedLux = "
                        + mLastObservedLux);
                //#endif /* VENDOR_EDIT */
            }
    ...
    private final class DisplayControllerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                //#ifdef VENDOR_EDIT
                //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/04/28, Add for 
                case MSG_LIGHT_SENSOR_CHANGED:
                    mAmbientLux = mLastObservedLux;
                    updateAutoBrightness(true);
                    break;                    
                //#endif /* VENDOR_EDIT */
            }
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/19, Add for 
    //private static final long LIGHT_SENSOR_DETECTED_DELAY_DARKENED = 5000;
    //private static final long LIGHT_SENSOR_DETECTED_DELAY_BRIGHTED = 3000;
    //Baoti.Li, 2013/08/16, reduce the delay time for faster change. 
    private static final long LIGHT_SENSOR_DETECTED_DELAY_DARKENED = 500;
    private static final long LIGHT_SENSOR_DETECTED_DELAY_BRIGHTED = 500;

    private void handleLightSensorChanged(long time, float lux){
        mHandler.removeMessages(MSG_LIGHT_SENSOR_CHANGED);        

        if (!mAmbientLuxValid) {
            mAmbientLuxValid = true;
            mLastObservedLux = lux;
            mAmbientLux = lux;
            mScreenAutoBrightness = mPowerRequest.screenBrightness;
            updateAutoBrightness(true);    
            return;
        }
        
        if (lux > mLastObservedLux) {
            if (mLastObservedLux > mAmbientLux) {
                mLastObservedLux = lux;
                mAmbientLux = lux;
                updateAutoBrightness(true);    
                return;
            ...
            mLastObservedLux = lux;
            mHandler.sendEmptyMessageAtTime(MSG_LIGHT_SENSOR_CHANGED, time + LIGHT_SENSOR_DETECTED_DELAY_BRIGHTED);
        } else {
            mLastObservedLux = lux;
            mHandler.sendEmptyMessageAtTime(MSG_LIGHT_SENSOR_CHANGED, time + LIGHT_SENSOR_DETECTED_DELAY_DARKENED);
        }
    }
    //#endif /* VENDOR_EDIT */
    ...
    private final SensorEventListener mLightSensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            if (mLightSensorEnabled) {
                ...
                //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/19, Add for 
                if (DEBUG) {
                    Slog.d(TAG, "Light-Sensor Changed: " + lux);
                }
                //#endif /* VENDOR_EDIT */
                ...
                */
                //#else /* VENDOR_EDIT */
                handleLightSensorChanged(time, lux);
                //#endif /* VENDOR_EDIT */
            }
        }
