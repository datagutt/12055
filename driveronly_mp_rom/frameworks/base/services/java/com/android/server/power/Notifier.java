...
final class Notifier {
    ...
    */
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/15, Add for 
    private final Intent mOppoScreenOnIntent;
    private final Intent mOppoScreenOffIntent;
    //#endif /* VENDOR_EDIT */
    ...
    public Notifier(Looper looper, Context context, IBatteryStats batteryStats,
        ...
        //#ifdef VENDOR_EDIT
        //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/15, Add for 
        mOppoScreenOnIntent = new Intent("com.oppo.SCREEN_ON");
        mOppoScreenOffIntent = new Intent("com.oppo.SCREEN_OFF");
        //#endif /* VENDOR_EDIT */
    ...
    private void sendWakeUpBroadcast() {
        ...
        if (ActivityManagerNative.isSystemReady()) {
            ...
            //#ifdef VENDOR_EDIT
            //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/15, Add for 
            mContext.sendBroadcastAsUser(mOppoScreenOnIntent, UserHandle.ALL);
            //#endif /* VENDOR_EDIT */
    ...
    private void sendGoToSleepBroadcast(int reason) {
        ...
        if (ActivityManagerNative.isSystemReady()) {
            ...
            //#ifdef VENDOR_EDIT
            //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/03/15, Add for 
            mContext.sendBroadcastAsUser(mOppoScreenOffIntent, UserHandle.ALL);
            //#endif /* VENDOR_EDIT */
