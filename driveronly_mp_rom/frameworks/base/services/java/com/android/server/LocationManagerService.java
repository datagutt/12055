...
public class LocationManagerService extends ILocationManager.Stub implements Runnable {
    ...
    private void checkPackageName(String packageName) {
        ...
        if (packages == null) {
            //#ifndef VENDOR_EDIT
            //LinJie.Xu@Prd.SysSrv.USB, 2013/04/06, Modify for 
            /*
        ...
        //#ifndef VENDOR_EDIT
        //Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/01/25, Modify for nearme id
        /*
        throw new SecurityException("invalid package name");
        */
        //#else /* VENDOR_EDIT */
        Slog.i(TAG, "error:invalid package name = " + packageName + " uid = " + uid);
        //#endif /* VENDOR_EDIT */
    }
        ...
        synchronized (mLock) {
            ...
            for (Receiver i : mReceivers.values()) {
                for (Map.Entry<String,UpdateRecord> j : i.mUpdateRecords.entrySet()) {
                    tmp.add(j.getValue().mReceiver.mUid);
                }
            }
            int size = tmp.size();
            if (size <= 0) {
