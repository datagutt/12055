...
//#ifndef VENDOR_EDIT
//Licx@OnLineRD.framework.statusbar_extend, add for statusbar transparent.
...
//#ifdef VENDOR_EDIT
//Wenhua.Leng@OnLineRD.framework.statusbar_extend, modify for make statusbar translucent
...
class WindowStateAnimator {
    ...
    void setSurfaceBoundariesLocked(final boolean recoveringMemory) {
        ...
        //#ifndef VENDOR_EDIT
        //licx@OnLineRD.framework.statusbar_extend, modify for make statusbar translucent
        //updateSurfaceWindowCrop(recoveringMemory);
        //#else
        boolean windowNotFullScreen = (mAttrFlags & WindowManager.LayoutParams.FLAG_FULLSCREEN) == 0;
		boolean systemUiNotFullScreen = (w.getSystemUiVisibility() & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0;
		boolean windowForceNotFullScreen = (mAttrFlags & WindowManager.LayoutParams.FLAG_FORCE_NOT_FULLSCREEN) != 0;
		boolean hasStatusBar = (windowNotFullScreen && systemUiNotFullScreen) || windowForceNotFullScreen;
        boolean showWallpaper = (mAttrFlags & WindowManager.LayoutParams.FLAG_SHOW_WALLPAPER) != 0;
        if (!showWallpaper && mAttrType != TYPE_WALLPAPER
				&& (!hasStatusBar || ((mAttrFlags & WindowManager.LayoutParams.FLAG_LAYOUT_INSET_DECOR) != 0))) {
            updateSurfaceWindowCrop(recoveringMemory);
        }
        //#endif /* VENDOR_EDIT */
    }
...
//        mSurfaceY = top;
        ...
        try {
            ...
            //#ifdef VENDOR_EDIT 
            //licx@OnLineRD.framework.statusbar_extend, delete for statusbar translucent
