    ...
    private void sendTetherStateChangedBroadcast() {
        ...
        if (usbTethered) {
            if (wifiTethered || bluetoothTethered) {
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //YanChen@Prd.SysApp.WIFI, 2012/08/21, Modify for change oppo wifiTethered icon
                /*
                    showTetheredNotification(com.android.internal.R.drawable.stat_sys_tether_general, "comb");
                */
                //#else /* VENDOR_EDIT */
                    showTetheredNotification(com.oppo.internal.R.drawable.oppo_stat_sys_tether_general, "comb");
                //#endif /* VENDOR_EDIT */
            } else {
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //Bingshu.Zhou@Prd.SysSrv.USB, 2012/08/09, Modify for 
                /*
            showTetheredNotification(com.android.internal.R.drawable.stat_sys_tether_usb, "usb");
                */
                //#else /* VENDOR_EDIT */
                showTetheredNotification(com.oppo.internal.R.drawable.oppo_stat_sys_tether_usb, "usb");
                //#endif /* VENDOR_EDIT */                
            }
            ...
            if (bluetoothTethered) {
                ...
                */
                ...
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //YanChen@Prd.SysApp.WIFI, 2012/08/12, Modify for change oppo wifi hotspot icon
                /*
                 showTetheredNotification(com.android.internal.R.drawable.stat_sys_tether_wifi, "wifi");
                */
                //#else /* VENDOR_EDIT */
                 showTetheredNotification(com.oppo.internal.R.drawable.oppo_stat_sys_tether_wifi, "wifi");
                //#endif /* VENDOR_EDIT */
            }
