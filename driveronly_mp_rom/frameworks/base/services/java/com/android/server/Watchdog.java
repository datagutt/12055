...
//#ifdef VENDOR_EDIT
//Zhanhong.Hu@SystemSrv.AMS, 2013/04/08, Add for 
//Sometimes a binder ask systemThread to bind a process which was suspended by OppoProcessManager.
//at that moment,the systemThread would be being monitor,WatchDog try to reboot system after a while.
//so we have to resume the suspended processes at the hadfway.This bug have happened before.
//For example,The EntranceGuard bind to qihoo360 by system_server,that leaded to the system_server was stucked.
                    Slog.v(TAG, "** Resume all processes which were suspended by OppoProcessManager.**");
                    //OppoBPMHelper.resumeAll();                    
//#endif /* VENDOR_EDIT */
