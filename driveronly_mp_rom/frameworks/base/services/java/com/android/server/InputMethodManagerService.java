...
//#ifdef VENDOR_EDIT
        // qinxin@Prd.MidWare.IME, 2012/7/4, Add for setting new IME as default
        //fulj@Plf.Framework.ime, upgrade android4.1 2012-09-28
        @Override public void onPackageAdded(String packageName, int uid) {
            if (DEBUG) Slog.d(TAG, "package " + packageName + " added");

            InputMethodInfo newInputMethod = null;
            synchronized (mMethodMap) {
                buildInputMethodListLocked(mMethodList, mMethodMap);
            ...
            if (newInputMethod != null) {
                Slog.i(TAG, "new inputmethod " + newInputMethod.getId() + " installed");
...
//#ifndef VENDOR_EDIT
        // qinxin@Prd.MidWare.IME, 2012/09/04, modified for ime switcher notification icon
        //fulj@Plf.Framework.ime, upgrade android4.1 2012-09-28
/*
        mImeSwitcherNotification.icon = com.android.internal.R.drawable.ic_notification_ime_default;
*/
//#else
        mImeSwitcherNotification.icon = com.android.internal.R.drawable.oppo_ic_notification_ime_default;
//#endif /* VENDOR_EDIT */
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        synchronized(mMethodMap) {
                            //#ifdef VENDOR_EDIT
                            //#@OppoHook
                            //LiuLei@EXP.GeneralApp.SDK, 2013/07/23, Modify for do not reset IME while change language
                            /*
                            checkCurrentLocaleChangedLocked();
                            */
                            //LiangJing.Fu@Plf.Framework.SDK, Add for reset ime subtype
                            resetImeSubtype();
                            //#endif /* VENDOR_EDIT */
                        }
                    }
    ...
    private boolean isValidSystemDefaultIme(InputMethodInfo imi, Context context) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //LiuLei@EXP.GeneralApp.IME, 2013/08/22, Add for 
        if(!OppoIMEUtils.isChinaRegion()){
            if(OppoIMEUtils.isRegionValidSystemIME(imi.getId())){
                return true;
            }else{
                return false;
            }
    ...
    public List<InputMethodInfo> getInputMethodList() {
        ...
        synchronized (mMethodMap) {
            //#ifndef VENDOR_EDIT
            //#@OppoHook
            //LiuLei@EXP.GeneralApp.IME, 2013/05/27, Modify for Filter the IME for Region except
            //China Region
            /*
                return new ArrayList<InputMethodInfo>(mMethodList);
            */
            //#else /* VENDOR_EDIT */ 
            return OppoIMEUtils.getRegionFilteredInputMethodList(new ArrayList<InputMethodInfo>(mMethodList));
            //#endif /* VENDOR_EDIT */     
        }
    }
...
//#ifndef VENDOR_EDIT
//Kaiyu.Zhong@Prd.Midware.IME,2013/03/29,Add for ime shown delay;
/*
						showCurrentInputLocked(InputMethodManager.SHOW_IMPLICIT, null);				
*/
//#else VENDOR_EDIT
						Thread thread = new Thread() {
                        	@Override public void run() {
                        		try {
									Slog.d(TAG,"The IME thread sleep 300ms, and then show ime!");
                        			sleep(300);
                            		showCurrentInputLocked(InputMethodManager.SHOW_IMPLICIT, null);	
                        		} catch (Exception e) {
                        			// do nothing
...
//#endif VENDOR_EDIT							
    ...
    private void showInputMethodMenuInternal(boolean showSubtypes) {
        ...
        synchronized (mMethodMap) {
            ...
            //#ifdef VENDOR_EDIT
            //Jianjun.Dan@Plf.Framework.SDK add inputmothod select 
            //com.android.internal.R.layout.input_method_switch_dialog_title, null);
            //else       
            final View tv = inflater.inflate(
                    com.oppo.internal.R.layout.oppo_input_method_switch_dialog_title, null);
            //#endif /* VENDOR_EDIT */   
    ...
    private static class InputMethodSettings {
        ...
        public List<InputMethodInfo> getEnabledInputMethodListLocked() {
            //#ifndef VENDOR_EDIT
            //#@OppoHook
            //LiuLei@EXP.GeneralApp.SDK, 2013/08/22, Modify for 
            /*
            return createEnabledInputMethodListLocked(
                    getEnabledInputMethodsAndSubtypeListLocked());
            */
            //#else /* VENDOR_EDIT */
            return OppoIMEUtils.getRegionFilteredInputMethodList(
                    createEnabledInputMethodListLocked(getEnabledInputMethodsAndSubtypeListLocked()));
            //#endif /* VENDOR_EDIT */            
        }
...
//#ifdef VENDOR_EDIT
//LiangJing.Fu@Plf.Framework.SDK, 2013-07-25, Add for reset ime subtype
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "LiangJing.Fu@Plf.Framework.SDK, Add for reset ime subtype")
    private void resetImeSubtype(){
        final Locale newLocale = mRes.getConfiguration().locale;
        InputMethodInfo imi = mMethodMap.get(mCurMethodId);
        final int N = imi.getSubtypeCount();
        for (int i = 0; i < N; ++i) {
            if (imi.getSubtypeAt(i).getLocale().equals(newLocale.toString())) {
                setSelectedInputMethodAndSubtypeLocked(imi, i, true);
                break;
            }
        }    
    }
