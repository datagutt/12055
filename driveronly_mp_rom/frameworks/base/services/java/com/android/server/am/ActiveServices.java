...
*/
//#else /* VENDOR_EDIT */
    static final int SERVICE_TIMEOUT = "user".equals(Build.TYPE) ? 20*1000 : 10*1000;
//#endif /* VENDOR_EDIT */
    ...
    private final void bumpServiceExecutingLocked(ServiceRecord r, String why) {
        ...
        if (r.executeNesting == 0 && r.app != null) {
        	...
        	OppoProcessManagerHelper.resumeProcessByUID(r.app.uid);
            //#endif VENDOR_EDIT
    ...
    void serviceTimeout(ProcessRecord proc) {
        ...
        if (anrMessage != null) {
            //#ifdef VENDOR_EDIT
            //ZhiYong.Lin@Plf.Framework modify for BPM 2013/01/21
        	if (OppoProcessManagerHelper.checkProcessWhileTimeout(proc)) {
        		return;
        	}
            //#endif VENDOR_EDIT
