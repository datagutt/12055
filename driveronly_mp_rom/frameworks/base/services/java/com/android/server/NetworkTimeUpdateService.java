...
public class NetworkTimeUpdateService {
    ...
    //#ifndef VENDOR_EDIT
    //LiuMing@Prd.SysApp.Settings, 2013/04/12, Modify for [enhance the probability of success]
    /*
    private static final int TRY_AGAIN_TIMES_MAX = 3;
    */
    //#else /* VENDOR_EDIT */
    private static final int TRY_AGAIN_TIMES_MAX = 5;
    //#endif /* VENDOR_EDIT */
    ...
    private void onPollNetworkTime(int event) {
        ...
        */
        ...
        if (mLastNtpFetchTime == NOT_SET || refTime >= mLastNtpFetchTime + POLLING_INTERVAL_MS
            ...
            //#ifndef VENDOR_EDIT
            //LiuMing@Prd.SysApp.Settings, 2013/05/07, Modify for [force refresh time when manual timing,
            //case last cached ntp time may be wrong sometimes]
            /*
            ...
            */
            //#else /* VENDOR_EDIT */
            if (mTime.getCacheAge() >= POLLING_INTERVAL_MS || event == EVENT_AUTO_TIME_CHANGED) {
                mTime.forceRefresh();
            }
            //#endif /* VENDOR_EDIT */
