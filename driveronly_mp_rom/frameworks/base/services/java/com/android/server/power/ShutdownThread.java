...
//#ifndef VENDOR_EDIT           
//LuoLong@Plat.Srv.BootAnim, 2013/04/12, for Kill the FM when reboot.
...
//                sInstance.mPowerManager.setBacklightBrightness(PowerManager.BRIGHTNESS_DIM);
    ...
    private static void checkShutdownFlow() {
        ...
        if (isIPOEnabled == true) {
            //#ifndef VENDOR_EDIT            
            //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/01/08, Modify for *#911# for shutdown the phone actually            
            /*            
            ...
            */            
            //#else /* VENDOR_EDIT */            
            if (("1".equals(SystemProperties.get("sys.ipo.battlow")))                 
                || ("1".equals(SystemProperties.get("sys.ipo.normalshutdown")))) {
                mShutdownFlow = NORMAL_SHUTDOWN_FLOW;  
            } else {
                mShutdownFlow = IPO_SHUTDOWN_FLOW;   
            }            
            ...
            //#ifdef VENDOR_EDIT            
            //Boning.li@Plat.Srv.poweronoff, 2013/07/02, add to delete ipo
            mShutdownFlow = NORMAL_SHUTDOWN_FLOW;
            //#endif /* VENDOR_EDIT */ 
...
//#ifndef VENDOR_EDIT           
//LuoLong@Plat.Srv.BootAnim, 2013/04/12, for killing the FM radio.
        mAudioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
        mAudioManager.requestAudioFocus(mAudioFocusListener, AudioSystem.STREAM_RING, AudioManager.AUDIOFOCUS_GAIN);
//#endif /* VENDOR_EDIT */
        ...
        if (mShutdownFlow == IPO_SHUTDOWN_FLOW) {
            ...
            // #ifndef VENDOR_EDIT            
            // LuoLong@Plat.Srv.PowerOnOff, 2013/03/28, Added start for Boot Animation.           
            String bootanimFinshed = SystemProperties.get("bootanim.finished");
            String bootanimLoop = SystemProperties.get("bootanim.loop");
            boolean retFin = (bootanimFinshed != null && bootanimFinshed.equals("1")) ? true : false;
            boolean retLoop = (bootanimLoop != null && bootanimLoop.equals("1")) ? true : false;
            boolean screenOn = retFin||retLoop;

            Log.e(TAG, "retFin," + retFin+"retLoop," + retLoop + "and screenOn" + screenOn);
            //#endif /* VENDOR_EDIT */
            // Added End.
            ...
            // Added End.
                ...
                //SystemProperties.set("ctl.stop","bootanim");
                        //#ifndef VENDOR_EDIT           
                        //LuoLong@Plat.Srv.BootAnim, 2013/03/28, Added start for Boot Animation. 
                        break;
                    }


                    bootanimFinshed = SystemProperties.get("bootanim.finished");
                    bootanimLoop = SystemProperties.get("bootanim.loop");
                    retFin = (bootanimFinshed != null && bootanimFinshed.equals("1")) ? true : false;
                    retLoop = (bootanimLoop != null && bootanimLoop.equals("1")) ? true : false;
                    screenOn = retFin||retLoop;
                    Log.e(TAG, "retFin," + retFin + "retLoop," + retLoop + "and screenOn" + screenOn);
                }
            }
            //#endif /* VENDOR_EDIT */
    ...
    public static void rebootOrShutdown(boolean reboot, String reason) {
        if (reboot) {
            ...
            //#ifndef VENDOR_EDIT           
            //LuoLong@Plat.Srv.BootAnim, 2013/03/28, Modified start for Boot Animation.          
