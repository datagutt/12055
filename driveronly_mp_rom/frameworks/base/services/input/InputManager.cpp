...
status_t InputManager::start() {
    ...
    if(strcmp(value, "eng") == 0){
        ...
        /*
        LightweightKeyDispatchAnr::IS_ENG_BUILD = true;
    	ALOGD("current build is eng build\n");
    	LightweightKeyDispatchAnr::createMonitorThread();
        */
        ALOGD("current build is eng build\n");
        /// @}
    }
    ...
    {
    	ALOGD("current build is user build\n");
    }	
    /// @}
