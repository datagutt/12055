...
public abstract class ManagedEGLContext {
    ...
    public static boolean doTerminate() {
        ...
        //#ifndef VENDOR_EDIT
        //fulj@Plf.MidWare.view, upgrade android4.1 2012/11/20
        //Pihe.Wu@Prd.MidWare.Theme, 2012/09/28, Modify for theme
        /*
        if (Looper.getMainLooper() != Looper.myLooper()) 
        */
        //#else /* VENDOR_EDIT */
        //some processes don't have main thread,for example:system_process
