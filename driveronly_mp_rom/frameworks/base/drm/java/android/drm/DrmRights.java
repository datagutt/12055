...
public class DrmRights {
    ...
    // M:
    // this constructor is added for OMA DRM v1.0 implementation.
    /**
     * Creates a <code>DrmRights</code> object with the given parameters.
     *
     * @param data raw data in array containing rights information.
     * @param mimeType MIME type.
     * @hide
     */
    public DrmRights(byte[] data, String mimeType) {
        mData = data;
        mMimeType = mimeType;
    }
}
