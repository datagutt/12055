...
{
    ALOGD("getNumberOfCameras +");  // debug log for process hang issue. will be removed after finding root cause
    jint numCameras = Camera::getNumberOfCameras();
    ALOGD("getNumberOfCameras (%d) -", numCameras); // debug log for process hang issue
    return numCameras;
}
