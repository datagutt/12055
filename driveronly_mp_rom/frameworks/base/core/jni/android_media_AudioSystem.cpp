...
static jintArray 
android_media_AudioSystem_getActiveAudioPids(JNIEnv *env, jobject thiz)
{   
    Vector<int> pids;    
    AudioSystem::getActiveAudioPids(pids);
...
static JNINativeMethod gMethods[] = {
	...
	//property=android.annotation.OppoHook.OppoRomType.OPPO
	//Chenps ZhiYong.Lin@Plf.Framework modify for BPM 2013/01/21
    {"getActiveAudioPids",       "()[I",     (void *)android_media_AudioSystem_getActiveAudioPids},  
    //#endif /* VENDOR_EDIT */
