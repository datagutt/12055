...
#ifdef VENDOR_EDIT
//ZhenHai.Long@SystemSRV,2012/02/04,add for 
extern int register_android_oppoutils_OppoUtils(JNIEnv *env);
#endif /*VENDOR_EDIT*/
...
static const RegJNIRec gRegJNI[] = {
    ...
    #ifdef VENDOR_EDIT
    //ZhenHai.Long@SystemSRV,2012/02/14,add for
    REG_JNI(register_android_oppoutils_OppoUtils),
    #endif /*VENDOR_EDIT*/	
};
