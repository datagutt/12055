...
//#ifdef VENDOR_EDIT
//YongDong.Zhang@Prd.MidWare.Res, 2013/01/30, Add for 
...
//#ifdef VENDOR_EDIT
//YongDong.Zhang@Prd.MidWare.Res, 2013/01/30, Add for add SearchEngine for upgrade 4.2
    ...
    public synchronized List<SearchEngineInfo> getSearchEngineInfos() {
        Log.d("zhangyd","searchManagerService method getSearchEngineInfos");
        Log.d("zhangyd","searchManagerService method " + (mSearchEngineInfos == null));
    ...
    private void initSearchEngineInfos() {
        ...
        Log.d("zhangyd","initSearchEngineInfos searchmanager =" + searchEngines.length);
        String sp = searchEngines[0];
        for (int i = 1; i < searchEngines.length; i++) {
            String configInfo = searchEngines[i];
            Log.d("zhangyd","in the circle  =" + configInfo);
       ...
       /* for (int i = 0; i < searchEngines.length; i++) {
            ...
            Log.d("zhangyd","in the circle  =" + name);
            SearchEngineInfo info = SearchEngineInfo.getSpecifiedSearchEngineInfo(mContext, name);
            mSearchEngineInfos.add(info);
            Log.d("zhangyd","searchmanager =" +  mSearchEngineInfos.size());
        }
        */
