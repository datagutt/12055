...
public final class ActivityThread {
    ...
    Resources getTopLevelResources(String resDir,
        ...
        //#ifndef VENDOR_EDIT
        //#@OppoHook
        //Yaojun.Luo@Plf.Framework.SDK : Add for rom theme.
        /*
        r = new Resources(assets, dm, config, compInfo);
        */
        //#else  /* VENDOR_EDIT */
        r = android.content.res.OppoClassFactory.newResources(assets, dm, config, compInfo);
        //#endif /* VENDOR_EDIT */
        if (false) {
    ...
    private Context createBaseContextForActivity(ActivityClientRecord r,
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013-09-05 : Add for oppo style
        int theme = r.activityInfo.getThemeResource();
        if (theme != 0) {
...
//Yaojun.Luo@Plf.Framework.SDK : Add for rom theme.
    ...
    Resources getTopLevelResources(String packageName, String resDir, 
            int displayId, Configuration overrideConfiguration,
            CompatibilityInfo compInfo) {
        Resources r = getTopLevelResources(resDir, displayId, overrideConfiguration, compInfo);
        if (null != r) {
            r.init(packageName);
        }
        return r;
...
//if we mount the sdcard to the PC at the moment,the system would reboot probability.
    ...
    public void ClearResourcesInActiveResources(Resources ref) { 
        ...
        while (it.hasNext()) { 
            ...
            if (r != null) { 
                if (r == ref) { 
                    Log.v(TAG, "Clear Resources In Active Resources");
                   it.remove(); 
                } 
            } 
        } 
