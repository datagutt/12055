...
//#endif /* VENDOR_EDIT */
    ...
    public boolean isActivityFirst = false;
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        ...
        if (context != null) {
            if(DEBUG)
                Log.v(TAG, "onCreate():" + context.getPackageName());
            Typeface.SetAppTypeFace(context.getPackageName());
        } else {
            if(DEBUG)
                Log.v(TAG, "onCreate():null/android");
...
//#endif /* VENDOR_EDIT */
    ...
    private void initActionBar() {
        ...
        //#ifndef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013/07/26, Modify for ActionBar of oppo style
        /*
            mActionBar = new ActionBarImpl(this);
        */
        //#else /* VENDOR_EDIT */
            mActionBar = com.android.internal.app.OppoActionBarImpl.newInstance(this);
        //#endif /* VENDOR_EDIT */
