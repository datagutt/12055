...
public class Notification implements Parcelable
{
	...
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_FIELD,
	                             property=android.annotation.OppoHook.OppoRomType.MTK,
								 note="")
	public static final int OPPO_ACTION_NORMAL = 0;

	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_FIELD,
	                             property=android.annotation.OppoHook.OppoRomType.MTK,
								 note="")
	public static final int OPPO_ACTION_CALL = 1;
    /**
    ...
    private static class Action implements Parcelable {
		...
		public int actionKind = OPPO_ACTION_NORMAL;
        ...
        private Action(Parcel in) {
			...
			//#ifdef VENDOR_EDIT
			//Hejiamiao@Plf.Keyguard.StatusBar, 2013/01/22, oppo notification
			icon = in.readInt();
			//#endif VENDOR_EDIT
        }
		...
		@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
	          property=android.annotation.OppoHook.OppoRomType.ROM,
			  note="make notification to oppo's")
        public Action(int icon_, CharSequence title_, PendingIntent intent_, int type_) {
            this(icon_, title_, intent_);
			actionKind = type_;
        }
		//#endif VENDOR_EDIT
    ...
    public void setLatestEventInfo(Context context,
        ...
        RemoteViews contentView = new RemoteViews(context.getPackageName(),
        		//#ifndef VENDOR_EDIT 
				//Hejiamiao@Keyguard.StatusBar, 2013/02/04, Modified for notification
                //R.layout.notification_template_base);
                //#else /* VENDOR_EDIT */
                com.oppo.internal.R.layout.oppo_notification_template_base);
                //#endif /* VENDOR_EDIT */
        if (this.icon != 0) {
            contentView.setImageViewResource(com.oppo.internal.R.id.icon, this.icon);
        }
        if (priority < PRIORITY_LOW) {
      
			contentView.setInt(com.oppo.internal.R.id.icon,
                    "setBackgroundResource", R.drawable.notification_template_icon_low_bg);
            contentView.setInt(com.oppo.internal.R.id.status_bar_latest_event_content,
                    "setBackgroundResource", R.drawable.notification_bg_low);
        }
        if (contentTitle != null) {
            contentView.setTextViewText(com.oppo.internal.R.id.title, contentTitle);
        }
        if (contentText != null) {
            contentView.setTextViewText(com.oppo.internal.R.id.text, contentText);
        }
        if (this.when != 0) {
            contentView.setViewVisibility(com.oppo.internal.R.id.time, View.VISIBLE);
            contentView.setLong(com.oppo.internal.R.id.time, "setTime", when);
        }
        if (this.number != 0) {
            NumberFormat f = NumberFormat.getIntegerInstance();
            contentView.setTextViewText(com.oppo.internal.R.id.info, f.format(this.number));
        }
    ...
    public static class Builder {
		...
		@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_CODE,
	          property=android.annotation.OppoHook.OppoRomType.ROM,
			  note="make notification to oppo's")
		public Builder addOppoAction(int icon, CharSequence title, PendingIntent intent, int kind) {
            mActions.add(new Action(icon, title, intent, kind));
            return this;
        }
        ...
        private RemoteViews applyStandardTemplate(int resId, boolean fitIn1U) {
            ...
            int smallIconImageViewId = com.oppo.internal.R.id.icon;
            if (mLargeIcon != null) {
                contentView.setImageViewBitmap(com.oppo.internal.R.id.icon, mLargeIcon);
                smallIconImageViewId = com.oppo.internal.R.id.right_icon;
            }
            ...
            if (mContentTitle != null) {
                contentView.setTextViewText(com.oppo.internal.R.id.title, mContentTitle);
            }
            if (mContentText != null) {
                contentView.setTextViewText(com.oppo.internal.R.id.text, mContentText);
                showLine3 = true;
            }
            if (mContentInfo != null) {
                contentView.setTextViewText(com.oppo.internal.R.id.info, mContentInfo);
                contentView.setViewVisibility(com.oppo.internal.R.id.info, View.VISIBLE);
                showLine3 = true;
            } else if (mNumber > 0) {
                final int tooBig = mContext.getResources().getInteger(
                        R.integer.status_bar_notification_info_maxnum);
                if (mNumber > tooBig) {
                    contentView.setTextViewText(com.oppo.internal.R.id.info, mContext.getResources().getString(
                                R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(com.oppo.internal.R.id.info, f.format(mNumber));
                }
                contentView.setViewVisibility(com.oppo.internal.R.id.info, View.VISIBLE);
                showLine3 = true;
            } else {
                contentView.setViewVisibility(com.oppo.internal.R.id.info, View.GONE);
            }

            // Need to show three lines?
            if (mSubText != null) {
                contentView.setTextViewText(com.oppo.internal.R.id.text, mSubText);
                if (mContentText != null) {
                    contentView.setTextViewText(com.oppo.internal.R.id.text2, mContentText);
                    contentView.setViewVisibility(com.oppo.internal.R.id.text2, View.VISIBLE);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(com.oppo.internal.R.id.text2, View.GONE);
                }
            } else {
                contentView.setViewVisibility(com.oppo.internal.R.id.text2, View.GONE);
            ...
            if (showLine2) {
                if (fitIn1U) {
                    ...
                    contentView.setTextViewTextSize(com.oppo.internal.R.id.text, TypedValue.COMPLEX_UNIT_PX, subTextSize);
                }
                // vertical centering
                contentView.setViewPadding(com.oppo.internal.R.id.line1, 0, 0, 0, 0);
            }

            if (mWhen != 0) {
                if (mUseChronometer) {
                    contentView.setViewVisibility(com.oppo.internal.R.id.chronometer, View.VISIBLE);
                    contentView.setLong(com.oppo.internal.R.id.chronometer, "setBase",
                            mWhen + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(com.oppo.internal.R.id.chronometer, "setStarted", true);
                } else {
                    contentView.setViewVisibility(com.oppo.internal.R.id.time, View.VISIBLE);
                    contentView.setLong(com.oppo.internal.R.id.time, "setTime", mWhen);
                }
            } else {
                contentView.setViewVisibility(R.id.time, View.GONE);
            }
            contentView.setViewVisibility(com.oppo.internal.R.id.line3, showLine3 ? View.VISIBLE : View.GONE);
            contentView.setViewVisibility(com.oppo.internal.R.id.overflow_divider, showLine3 ? View.VISIBLE : View.GONE);
            return contentView;
        }
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId) {
            ...
            if (N > 0) {
                ...
                big.setViewVisibility(com.oppo.internal.R.id.actions, View.VISIBLE);
                big.setViewVisibility(com.oppo.internal.R.id.action_divider, View.VISIBLE);
                if (N>MAX_ACTION_BUTTONS) N=MAX_ACTION_BUTTONS;
                big.removeAllViews(com.oppo.internal.R.id.actions);
                for (int i=0; i<N; i++) {
                    final RemoteViews button = generateActionButton(mActions.get(i));
                    //Log.d("Notification", "adding action " + i + ": " + mActions.get(i).title);
                    big.addView(com.oppo.internal.R.id.actions, button);
                }
            }
            return big;
        }
        ...
        private RemoteViews makeContentView() {
            if (mContentView != null) {
                ...
                //#else /* VENDOR_EDIT */
                return applyStandardTemplate(com.oppo.internal.R.layout.oppo_notification_template_base, true); // no more special large_icon flavor
                //#endif /* VENDOR_EDIT */
            }
        }
            ...
            if (mTickerView != null) {
                ...
                if (mContentView == null) {
                    return applyStandardTemplate(mLargeIcon == null
							...
							//#else /* VENDOR_EDIT */
							? com.oppo.internal.R.layout.oppo_status_bar_latest_event_ticker
                            : com.oppo.internal.R.layout.oppo_status_bar_latest_event_ticker_large_icon, true);
							//#endif /* VENDOR_EDIT */
                } else {
                    return null;
                }
        ...
        private RemoteViews makeBigContentView() {
			...
			//#else /* VENDOR_EDIT */
			return applyStandardTemplateWithActions(com.oppo.internal.R.layout.oppo_notification_template_big_base);
			//#endif /* VENDOR_EDIT */
        }
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(mContext.getPackageName(), 
					...
					//#else /* VENDOR_EDIT */
					tombstone ? com.oppo.internal.R.layout.oppo_notification_action_tombstone
                              : com.oppo.internal.R.layout.oppo_notification_action);
					if (action.actionKind == OPPO_ACTION_CALL) {
						button = new RemoteViews(mContext.getPackageName(), com.oppo.internal.R.layout.oppo_notification_action_call);
					} 
					//#endif /* VENDOR_EDIT */
            button.setTextViewCompoundDrawables(com.oppo.internal.R.id.action0, action.icon, 0, 0, 0);
            button.setTextViewText(com.oppo.internal.R.id.action0, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(com.oppo.internal.R.id.action0, action.actionIntent);
            }
            button.setContentDescription(com.oppo.internal.R.id.action0, action.title);
            return button;
        }
    ...
    public static abstract class Style
    {
        ...
        protected RemoteViews getStandardView(int layoutId) {
            ...
            if (mBigContentTitle != null && mBigContentTitle.equals("")) {
                contentView.setViewVisibility(com.oppo.internal.R.id.line1, View.GONE);
            } else {
                contentView.setViewVisibility(com.oppo.internal.R.id.line1, View.VISIBLE);
            }
            ...
            if (overflowText != null) {
                contentView.setTextViewText(com.oppo.internal.R.id.text, overflowText);
                contentView.setViewVisibility(com.oppo.internal.R.id.overflow_divider, View.VISIBLE);
                contentView.setViewVisibility(com.oppo.internal.R.id.line3, View.VISIBLE);
            } else {
                contentView.setViewVisibility(com.oppo.internal.R.id.overflow_divider, View.GONE);
                contentView.setViewVisibility(com.oppo.internal.R.id.line3, View.GONE);
            }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
			...
			//#else /* VENDOR_EDIT */
			RemoteViews contentView = getStandardView(com.oppo.internal.R.layout.oppo_notification_template_big_picture);
			//#endif /* VENDOR_EDIT */

            contentView.setImageViewBitmap(com.oppo.internal.R.id.big_picture, mPicture);
    ...
    public static class BigTextStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
			...
			//#else /* VENDOR_EDIT */
			RemoteViews contentView = getStandardView(com.oppo.internal.R.layout.oppo_notification_template_big_text);
			//#endif /* VENDOR_EDIT */
            ...
            contentView.setTextViewText(com.oppo.internal.R.id.big_text, mBigText);
            contentView.setViewVisibility(com.oppo.internal.R.id.big_text, View.VISIBLE);
            contentView.setViewVisibility(com.oppo.internal.R.id.text2, View.GONE);
    ...
    public static class InboxStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
			...
			//#else /* VENDOR_EDIT */
			RemoteViews contentView = getStandardView(com.oppo.internal.R.layout.oppo_notification_template_inbox);
			//#endif /* VENDOR_EDIT */

            contentView.setViewVisibility(com.oppo.internal.R.id.text2, View.GONE);

            int[] rowIds = {com.oppo.internal.R.id.inbox_text0, com.oppo.internal.R.id.inbox_text1, com.oppo.internal.R.id.inbox_text2, com.oppo.internal.R.id.inbox_text3,
                    com.oppo.internal.R.id.inbox_text4, com.oppo.internal.R.id.inbox_text5, com.oppo.internal.R.id.inbox_text6};
