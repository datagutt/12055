...
//#ifdef VENDOR_EDIT
    ...
    public static final int RTC_POWER_ON   = 6;
    public static final String ALARM_PACKAGE_NAME = "com.oppo.alarmclock";
    public static final String ALARM_BOOT_WINDOW  = "com.oppo.alarmclock.alarmclock.AlarmAlertFullScreen";
//#endif /* VENDOR_EDIT */
    ...
    public void removePackagesAlarms(String[] pkgList) {
        try {
            mService.removePackagesAlarms(pkgList);
        } catch (RemoteException ex) {
        }
    }
	//#endif /* VENDOR_EDIT */
