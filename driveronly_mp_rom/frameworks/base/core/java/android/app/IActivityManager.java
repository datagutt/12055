...
public interface IActivityManager extends IInterface {
    ...
    int NOTIFY_WINDOW_TIMEOUT = IBinder.FIRST_CALL_TRANSACTION + 160;

    /// M: ALPS00431397. When running window animation, halt the activity
    /// launchigng. Otherwise, restore the activity state @{
    int HALT_ACTIVITY_RESUMING = IBinder.FIRST_CALL_TRANSACTION + 161;
    int RESTORE_ACTIVITY_RESUMING = IBinder.FIRST_CALL_TRANSACTION + 162;
    /// @}
}
