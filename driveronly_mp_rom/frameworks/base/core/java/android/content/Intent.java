...
public class Intent implements Parcelable, Cloneable {
    ...
    //#ifdef VENDOR_EDIT
	//zhiyong.lin@Plf.Framework.AMS, port for upgrade android4.1 2012-09-20
    //Jiaming.Feng@MM.Music, 2012/06/12, Add for      	
    /**
     * Broadcast Action:  External media is pre-unmounted because it is being shared via USB mass storage.
     */
...
//#ifdef VENDOR_EDIT
	//zhiyong.lin@Plf.Framework.AMS, port for upgrade android4.1 2012-09-20
	/**
	 *  ACTION_OPPO_PACKAGE_DATA_CLEARED for app,and this can be handle by app.2010-6-14
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_OPPO_PACKAGE_DATA_CLEARED = "android.intent.action.OPPO_PACKAGE_DATA_CLEARED";
//#endif //VENDOR_EDIT

//#ifdef VENDOR_EDIT
	//zhiyong.lin@Plf.Framework.AMS, port for upgrade android4.1 2012-09-20
	//Fangfang.Hui@Prd.PlatSrv.OTA, 2012/06/11, Add for OTA update intent
    /**
     * oppo.linzy:add ACTION_OPPO_OTA_UPDATE_SUCCESSED and
     * ACTION_OPPO_OTA_UPDATE_FAILED for OTA update, and this can be handle by
     * app. 2011-11-9
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
...
//#ifdef VENDOR_EDIT
	//zhiyong.lin@Plf.Framework.AMS, port for upgrade android4.1 2012-09-20
	//WangHu@Prd.Audio.MediaProvider, 2012/06/21, Add for new intent for MediaScanner.
	/**
     * Broadcast Action:  Request the media scanner to scan directory and add it to the media database.
     * The path to the directory is contained in the Intent.mData field.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
	public static final String ACTION_MEDIA_SCANNER_SCAN_DIRECTORY = "oppo.intent.action.MEDIA_SCAN_DIRECTORY";

	/**
	 * Broadcast Action:  Request the media scanner to scan all volume and add it to the media database.
	 */
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
	public static final String ACTION_MEDIA_SCANNER_SCAN_ALL = "oppo.intent.action.MEDIA_SCAN_ALL";

	/**
	 * Broadcast Action:  Notify the file encrypt to switch the state of FILE_ENCRYPT.
	 * the BooleanExtra "status" in the intent to point the state.
	 * eg. FileEncryptReceiver.java
	 */
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
	public static final String ACTION_FILE_ENCRYPT_STATE_CHANGED = "oppo.intent.action.encrypt.stateChanged";

	/**
	 * Broadcast Action:  Notify the file encrypt to encrypt files in the directory.
	 * the directory is contained in the Intent.mData field.
	 * eg. FileEncryptReceiver.java
	 */
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
	...
	/**
	 * Broadcast Action:  Notify the file encrypt to decrypt files in the directory.
	 * the directory is contained in the Intent.mData field.
	 * eg. FileEncryptReceiver.java
	 */
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
...
//#ifdef VENDOR_EDIT
//Zhanhong.Hu@Prd.SystemSrv.AMS, 2012/05/31, Add for activity proctected.
	public static final int OPPO_FLAG_ACTIVITY_SECURE_POLICY = 0X00000200;    
//#endif /* VENDOR_EDIT */
