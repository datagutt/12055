...
public class ResolveInfo implements Parcelable {
	...
	private final static String TAG = "ResolveInfo";
	//#endif /* VENDOR_EDIT */
    /**
    ...
    public Drawable loadIcon(PackageManager pm) {
        ...
        if (resolvePackageName != null && icon != 0) {
        	...
        	//#@OppoHook
        	//#luoyajun@Plf.Framework.SDK add for rom theme
            dr = loadDrawableFromTheme(pm, resolvePackageName, null);
            if (null == dr){
    ...
    private Drawable loadDrawableFromTheme(PackageManager pm, String packageName, ApplicationInfo ai) {
        ComponentInfo ci = activityInfo != null ? activityInfo : serviceInfo;
        return OppoThemeHelper.getDrawable(pm, packageName, icon, ai, ci, OppoThemeHelper.isCustomizedIcon(filter));
    }
	//#endif /* VENDOR_EDIT */
