...
public abstract class PackageManager {
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/7/16,add for loginmode
    public static final int GET_PRIVACY_PACKAGES = 0x00100000;
    public static final int GET_HIDDEN_PACKAGES = 0x01000000;
    public static final int GET_ALL_PACKAGES = 0x10000000;
    public static final int CLEAR_VISITOR_PACKAGES = 0x00008000;
    public static final int GET_VISITOR_PACKAGES = 0x00040000;
    public static final int USEDTO_SUIT_LOGINMODE = 0x00080000;
    //#endif VENDOR_EDIT
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21
    public static final int INSTALL_METH = 0x00000020;
    public static final int LOGINMODE_NORMAL = 0;
    public static final int LOGINMODE_USRHIDE = 1;
    public static final int LOGINMODE_PRIVACE = 2;
    //#endif VENDOR_EDIT
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21, add for 
    public static final int INSTALL_FAILED_NO_PERMISSION = -24; 

    public static final int INSTALL_FAKE_INSTALL_SUCCEEDED = -25;
    ...
    //#ifdef VENDOR_EDIT
	//zhiyong.lin@Plf.Framework.PMS, modify for sdcard apk installed 2012-09-24
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,add to nofity for launcher 
    public static final String ACTION_LOAD_EXTERNAL_APK_FOR_OPPO = 
    		"com.oppo.android.pm.EXTERNAL_PACKAGES_LOAD_OK";

    public static final String ACTION_UNLOAD_EXTERNAL_APK_FOR_OPPO = 
    		"com.oppo.android.pm.EXTERNAL_PACKAGES_UNLOAD_OK";

    public static final String EXTERNAL_APK_SUM = 
    		"com.oppo.android.pm.EXTERNAL_PACKAGES_SUM";
    //#endif /*VENDOR_EDIT*/
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,add for double res
    /*
    public abstract PackageInfo getPackageInfoFromPath(String resDirName)
            throws NameNotFoundException;
	 */
    //#endif /*VENDOR_EDIT*/
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,add for
    public abstract Intent getLaunchIntentForPackage(String packageName, int flags);
    //#endif /*VENDOR_EDIT*/
	...
	//#idef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21, add to ignore the signatures checking of some special apps (e.g nearme)
/*
	public abstract boolean isTrustSignatureApp(String PackageName);

    public abstract int setLoginMode(String packageName, int nLoginMode);
    public abstract int getLoginMode(String packageName);
 */
    //#endif /*VENDOR_EDIT*/   
}
