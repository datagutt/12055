...
//#ifdef VENDOR_EDIT
//yaoshuang.zhang@Plf.SysSrv.PMS,2012/06/21, add for double res
//    PackageInfo getPackageInfoFromPath(String resDirName);
//#endif // VENDOR_EDIT
...
//#ifdef VENDOR_EDIT
//WangLan@Plf.Framework.PMS add for permission control
//    void modifyPermissions(in String pkg, in List<String> list, boolean disable);
//    List<String> getDisabledPermissions(in String pkg);

//zhiyong.lin@Plf.Framework.PMS, remove for jieou 2012-09-24    
//    boolean dosSdcardApkInstalled();
//    boolean dosDataAppApkInstalled();
//    boolean dosInstallingOnSd();
//#endif /* VENDOR_EDIT */
//#ifdef VENDOR_EDIT
//yaoshuang.zhang@Plf.SysSrv.PMS,2012/06/21, add to ignore the signatures checking of some special apps (e.g nearme)
//    boolean isTrustSignatureApp(in String PackageName);
//    int setLoginMode(in String packageName, in int nLoginMode);
//    int getLoginMode(in String packageName);
//#endif /*VENDOR_EDIT*/  
}
