...
//#ifdef VENDOR_EDIT
//yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,add for build
import java.util.Arrays;
//#endif VENDOR_EDIT
//#ifdef VENDOR_EDIT
//#@OppoHook
//#luoyajun@Plf.Framework.SDK add for rom theme.
import android.content.res.OppoClassFactory;
//#endif /* VENDOR_EDIT */
/**
...
public class PackageParser {
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,added to avoid dex not found exception in eng mode
    private final String[] mTrustApkArray = {
        "com.uc.browser",
        "com.tencent.qq",
        "com.youdao.dict",
        "com.sina.weibo",
        ...
        "com.dianping.v1",
    };//add packagename here

    private String oppopackageflag = "com.oppo.";
    private final ArrayList<String> mTrustApkList = new ArrayList(Arrays.asList(mTrustApkArray));
    //#endif /* VENDOR_EDIT */
    ...
    */
    ...
    public static PackageInfo generatePackageInfo(PackageParser.Package p,
        ...
        //#ifdef VENDOR_EDIT
        //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21, add for hidding apps
        pi.mLoginMode = p.mLoginMode;
        //#endif /*VENDOR_EDIT*/
    ...
    public Package parsePackage(File sourceFile, String destCodePath,
        ...
        try {
            ...
            if (cookie != 0) {
				...
				//else
                res = OppoClassFactory.newResources(assmgr, metrics, null);
				//#endif /* VENDOR_EDIT */
            ...
            //#ifdef VENDOR_EDIT
			//#@OppoHook
				//ZhiYong.Lin@Plf.Framework.PMS, modify for for apk encryption 2012-12-17
                parser = assmgr.openXmlResourceParserInOppoEncryption(cookie, ANDROID_MANIFEST_FILENAME);
                //#else
    ...
    public boolean collectCertificates(Package pkg, int flags) {
        ...
        try {
            ...
            */
            //#else /* VENDOR_EDIT */
            if ((flags&PARSE_IS_SYSTEM) != 0 
                    || mTrustApkList.contains(pkg.packageName) 
                    || pkg.packageName.contains(oppopackageflag)) {            
            //#endif /* VENDOR_EDIT */
                ...
                OppoOpkParserUtil.checkImeiForOpk(jarFile);
                //#endif VENDOR_EDIT
                ...
                while (entries.hasMoreElements()) {
					...
					//#@OppoHook
					//ZhiYong.Lin@Plf.Framework.PMS, add for apk encryption 2012-12-17
                    if (OppoOpkParserUtil.checkFileForOpk(jarFile, je)) {
                    	continue;
                    }                    
                    //#endif VENDOR_EDIT
    ...
    public static PackageLite parsePackageLite(String packageFilePath, int flags) {
        ...
        try {
            ...
            //#ifdef VENDOR_EDIT
			//#@OppoHook
			//ZhiYong.Lin@Plf.Framework.PMS, modify for apk encryption 2012-12-17
            parser = assmgr.openXmlResourceParserInOppoEncryption(cookie, ANDROID_MANIFEST_FILENAME);
            //#else
            //parser = assmgr.openXmlResourceParser(cookie, ANDROID_MANIFEST_FILENAME);          
            //#endif VENOR_EDIT
    ...
    private static String parsePackageName(XmlPullParser parser,
        ...
        //ifndef VENDOR_EDIT
        //@OppoHook.OPPO 
        //Jianjun.Dan@Plf.Framework.SDK
        //if (nameError != null && !"android".equals(pkgName)
        //else
        if (nameError != null && !"android".equals(pkgName) && !"oppo".equals(pkgName)) {
        //endif /* VENDOR_EDIT */
    ...
    private Package parsePackage(
        ...
        //#ifdef VENDOR_EDIT
        //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21,porting
        //ZhenHai.Long@SystemSRV, , add for hiding apps
        pkg.mLoginMode = PackageManager.LOGINMODE_NORMAL; 
        //#endif /*VENDOR_EDIT*/
    ...
    public final static class Package {
        ...
        //yaoshuang.zhang@Prd.SysSrv.PMS,2012/06/21, add for hiding apps
        public int mLoginMode;
        public int mVisitorApp = 0;
        //#endif /*VENDOR_EDIT*/
