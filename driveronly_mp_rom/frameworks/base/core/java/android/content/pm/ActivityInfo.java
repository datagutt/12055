...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
    ...
    /**
     * Bit in {@link #configChanges} that indicates that the activity
     * can itself handle changes to the font flipping action.  Set from the
     * {@link android.R.attr#configChanges} attribute.  This is
     * not a core resource configuration, but a higher-level value, so its
     * constant starts at the high bits.
     */
    public static final int CONFIG_FLIPFONT   = 0x20000000;
    // FlipFont }
//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        0x8000, // flip font        // ToDo(mti) -- not needed ?
        // FlipFont }
//#endif /* VENDOR_EDIT */
    };
    /** @hide
