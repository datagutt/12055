...
public class TypedArray {
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_CODE,
                      ...
                      note="XiaoKang.Feng@Plf.Framework, modify for oppo theme")
    public int getDimensionPixelSize(int index, int defValue) {
        ...
        if (type == TypedValue.TYPE_NULL) {
            ...
            if (null != mResources.getThemeInt(data[index + AssetManager.STYLE_RESOURCE_ID])){
                return mResources.getThemeInt(data[index + AssetManager.STYLE_RESOURCE_ID]).intValue();
            }
            //#endif /* VENDOR_EDIT */
