...
import oppo.content.res.OppoThemeResourcesSystem;
import oppo.content.res.OppoThemeZipFile;
...
public class Resources {
    ...
    /*OPPO 2013/03/04 luoyaojun add begin for [rom theme]*/
	...
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_FIELD,
  	...
  	public void init(String name){
				if ((TextUtils.isEmpty(name)) || ("android".equals(name)) || ("oppo".equals(name))){
						mThemeResources = OppoThemeResources.getSystem(this);
				}else{
						mThemeResources = OppoThemeResourcesPackage.getThemeResources(this, name);
				}
				
				if (null != mThemeResources){
						mIsHasValues = mThemeResources.hasValues();
				}
		}
		...
		public Drawable loadOverlayDrawable(TypedValue value, int id) {
    	  ...
    	  if (null == mSkipFiles.get(id)&&(null != mThemeResources)){
    	  		String path = value.string.toString();
    	  		OppoThemeZipFile.ThemeFileInfo themeFileInfo = mThemeResources.getThemeFileStream(getCookieType(value.assetCookie), path);
    	  		if (null == themeFileInfo){
    	  		...
    	  		try{
	  						...
	  						drawable = Drawable.createFromResourceStream(this, value, input, path, options);
    ...
    private int getCookieType(int id){
    		int i = mCookies.get(id);
    		String packageName = null;
    		if (0 == i){
    				packageName	= mAssets.getCookieName(id);
    				if ("/system/framework/framework-res.apk".equals(packageName)){
    						i = 1;
    				}else if ("/system/framework/oppo-framework-res.apk".equals(packageName)){
    					  i = 2;
    				}else{
    					  i = 3;
    				}
    ...
    public Integer getThemeInt(int id){
    		...
    		if (!mIsHasValues){
    				...
    				if (index >= 0){
    						res = (Integer)this.mIntegers.valueAt(index);
    				}else{
    						res = mThemeResources.getThemeInt(id);
    						mIntegers.put(id, res);
    				}
    		}
    ...
    public Drawable loadIcon(int id){
        ...
        //Xiaokang.Feng@Plf.Framework.SDK, 2013/07/09, Modify for ConvertIcon
    		...
    		if (null == mSkipFiles.get(id)&&(null != mThemeResources)){
    			  OppoThemeZipFile.ThemeFileInfo themeFileInfo = mThemeResources.getSystem().getIconStream(path);
    				if (null == themeFileInfo){
    	  					mSkipFiles.put(id, Boolean.valueOf(true));
    	  					return null;
    	  		}
		...
		*/
        //#else /* VENDOR_EDIT */
        return loadIcon(id,null);
        //#endif /* VENDOR_EDIT */		
    }
	
    //#ifdef VENDOR_EDIT
    //XiaoKang.Feng@Plf.Framework, 2013/07/09, Add for ConvertIcon
   
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="XiaoKang.Feng@Plf.Framework, add for ConvertIcon")
    ...
    private TypedArray replaceTypedArray(TypedArray typedarray){
    		if (mIsHasValues){
                ...
                int id = ai[i + 3];
                 //#ifdef VENDOR_EDIT
                //#Xiaokang.Feng@Plf.Framework.SDK, 2013-06-08,Modify for dimens
    ...
    /*OPPO 2013/03/04 luoyaojun add end.*/
    ...
    public static Resources getSystem() {
        synchronized (mSync) {
            ...
            if (ret == null) {
				...
				//ret = new Resources();
				//else
                ret = OppoClassFactory.newResources();
				//#endif /* VENDOR_EDIT */
                mSystem = ret;
            }
    ...
    public Drawable getDrawable(int id) throws NotFoundException {
        //Theme manager +
		//#ifndef VENDOR_EDIT
		//Pantengjiao@GraphicTech, 2013/09/23, Remove for application of slow start 
		/*
    ...
    public final class Theme {
        ...
        public TypedArray obtainStyledAttributes(int[] attrs) {
            ...
            //return array;
            //else
            return replaceTypedArray(array);
            //#endif /* VENDOR_EDIT */
        }
    ...
    public void updateConfiguration(Configuration config,
        ...
        /*OPPO 2013/01/28 luoyaojun add for [rom theme.]*/    
        int i = 0;	
    	if (null != mConfiguration && null != config){
    		i = mConfiguration.diff(config);
    	}else{
    		i = 0;
    	} 
		/*OPPO 2013/01/28 luoyaojun add end.*/
        synchronized (mTmpValue) {
            if (false) {
            ...
            if (config != null) {
				...
				//else
                configChanges = ActivityInfo.activityInfoConfigToNative(configChanges)
                                | (configChanges & OppoExtraActivityInfo.CONFIG_OLD_SKIN_MASK)
                                | (configChanges & OppoExtraActivityInfo.CONFIG_NEW_SKIN_MASK);
				//#endif /* VENDOR_EDIT */
            }
        ...
        /*OPPO 2013/03/04 luoyaojun add begin for [rom theme]*/
        if ((mThemeResources != null) && (((i & 0x200) != 0) || (OppoExtraConfiguration.needNewResources(i)))){
    ...
    /*package*/ Drawable loadDrawable(TypedValue value, int id)
        ...
        if (cs != null) {
            ...
            if (dr == null) {
            	...
            	//#@OppoHook
            	//#luoyajun@Plf.Framework.SDK add for rom theme.
                } else if ((dr = loadOverlayDrawable(value, id)) == null){
				//#endif /* VENDOR_EDIT */
                    try {
    ...
    static void clearPreloadedCache(){
	  ...
	  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_FIELD,
	                property=android.annotation.OppoHook.OppoRomType.ROM,
				  note="XiaoKang.Feng@Plf.Framework, add for rom themeb")   
     private static boolean themeChanged=false;
	 @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      property=android.annotation.OppoHook.OppoRomType.ROM,
		                      note="add for rom theme")
