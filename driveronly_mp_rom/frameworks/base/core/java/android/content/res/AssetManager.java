...
//#ifdef VENDOR_EDIT	   
//#@OppoHook
//ZhiYong.Lin@Plf.Framework add for encryption 2012-12-15
import android.encryption.OppoEncryption;
//#endif /* VENDOR_EDIT */.
...
public final class AssetManager {
    ...
    public AssetManager() {
        synchronized (this) {
            ...
            //#ifdef VENDOR_EDIT
            //#@OppoHook
            //#Jianjun.Dan@Plf.Framework.SDK add asset paths   
    ...
    /**
     * this method is add for apk encryption.
     */
    ...
    public final XmlResourceParser openXmlResourceParserInOppoEncryption(int cookie,
            String fileName) throws IOException {
        XmlBlock block = openXmlBlockAssetInOppoEncryption(cookie, fileName);
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property=android.annotation.OppoHook.OppoRomType.ROM,
			note="ZhiYong.Lin@Plf.Framework add for encryption")
    final XmlBlock openXmlBlockAssetInOppoEncryption(int cookie, String fileName)
        throws IOException {
        synchronized (this) {
            if (!mOpen) {
                throw new RuntimeException("Assetmanager has been closed");
        	...
        	//#ifndef VENDOR_EDIT
            //#@OppoHook
            //ZhiYong.Lin@Plf.Framework add for encryption
            //int xmlBlock = openXmlAssetNativeInOppoEncryption(cookie, fileName);
            //#else
			OppoEncryption oppoEncryption = OppoEncryption.getInstance();
            oppoEncryption.initAssetManager(mObject);
            int xmlBlock = oppoEncryption.openXmlAssetInOppoEncryption(cookie, fileName);
            //Log.d("OppoEncryption", "OppoEncryption.OpenXmlAssetInOppoEncryption xmlBlock == " + xmlBlock + "!!!");
            //#endif VENDOR_EDIT
            
            if (xmlBlock != 0) {
                XmlBlock res = null;
                //String[] arrry = getAssetPaths();
    ...
    */
    ...
    public void callDestory() {
        try { 
            //Log.w(TAG, "AssetManager callDestory"); 
            destroy();
        } catch(Exception e) {
            e.printStackTrace();
        }
