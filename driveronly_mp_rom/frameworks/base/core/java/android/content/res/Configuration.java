...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public OppoExtraConfiguration mOppoExtraConfiguration = null;
	//#endif /* VENDOR_EDIT */
...
//#endif /* VENDOR_EDIT */
    ...
    public Configuration() {
        ...
        //#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
        mOppoExtraConfiguration = new OppoExtraConfiguration();
		//#endif /* VENDOR_EDIT */
        setToDefaults();
    }
	...
	@OppoHook(level=OppoHook.OppoHookType.CHANGE_CODE,note="FlipFont, luoyaojun modify for rom theme")
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
		...
		//#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
		mOppoExtraConfiguration.setTo(o.mOppoExtraConfiguration);
		//#endif /* VENDOR_EDIT */
    }
...
//#endif /* VENDOR_EDIT */
		...
		//#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
	 	sb.append(mOppoExtraConfiguration.toString());
		//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
		...
		//#@OppoHook
		//#luoyajun@Plf.Framework.SDK add for rom theme.
	 	mOppoExtraConfiguration.setToDefaults();
		//#endif /* VENDOR_EDIT */
//#endif /* VENDOR_EDIT */
    }
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if (delta.FlipFont > 0 && FlipFont != delta.FlipFont) {
            changed |= ActivityInfo.CONFIG_FLIPFONT;
            FlipFont = delta.FlipFont;
        }
        if(DEBUG) Log.v(MonoTAG, "Configuration UpdateFrom changed=" + changed);
        // FlipFont }
//#endif /* VENDOR_EDIT */
		//#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
	 	changed |= mOppoExtraConfiguration.updateFrom(delta.mOppoExtraConfiguration);
		//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if (FlipFont != delta.FlipFont) {
            changed |= ActivityInfo.CONFIG_FLIPFONT;
        }
        if(DEBUG) Log.v(MonoTAG, "Configuration diff changed=" + changed);
        // FlipFont }
		//#ifdef VENDOR_EDIT
        //#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
	 	changed |= mOppoExtraConfiguration.diff(delta.mOppoExtraConfiguration);
		//#endif /* VENDOR_EDIT */
//#endif /* VENDOR_EDIT */
...
//#ifndef VENDOR_EDIT
//baoqibiao@GraphicTech.Graphics, port FlipFont for ROM 2012-12-15
//		  return (configChanges & (interestingChanges|ActivityInfo.CONFIG_FONT_SCALE)) != 0;
//#else
		//#ifdef VENDOR_EDIT
        //#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
		return ((configChanges & (interestingChanges|ActivityInfo.CONFIG_FONT_SCALE|ActivityInfo.CONFIG_FLIPFONT )) != 0
				||OppoExtraConfiguration.needNewResources(configChanges));
		//#endif /* VENDOR_EDIT */
//#endif /* VENDOR_EDIT */
...
//#ifdef VENDOR_EDIT
//baoqibiao@GraphicTech.Graphics, port FlipFont for ROM 2012-12-15
        dest.writeInt(FlipFont);
//#endif /* VENDOR_EDIT */		
		//#ifdef VENDOR_EDIT
        //#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
		mOppoExtraConfiguration.writeToParcel(dest, flags);
		//#endif /* VENDOR_EDIT */
    }
...
//#ifdef VENDOR_EDIT
//baoqibiao@GraphicTech.Graphics, port FlipFont for ROM 2012-12-15
        FlipFont = source.readInt();
//#endif /* VENDOR_EDIT */     
		//#ifdef VENDOR_EDIT
         //#@OppoHook
         //#luoyajun@Plf.Framework.SDK add for rom theme.
		 mOppoExtraConfiguration.readFromParcel(source);
		 //#endif /* VENDOR_EDIT */
    }
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        ...
        if(DEBUG) Log.v(MonoTAG, "Configuration CompareTo n=" + n);

        // FlipFont }
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //#luoyajun@Plf.Framework.SDK add for rom theme.
	 	n = mOppoExtraConfiguration.compareTo(that.mOppoExtraConfiguration);
		//#endif /* VENDOR_EDIT */
//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        result = 31 * result + FlipFont;

        if(DEBUG) Log.v(MonoTAG, "Configuration HashCode result=" + result);
        // FlipFont }
//#endif /* VENDOR_EDIT */
        //#ifndef VENDOR_EDIT
        //#@OppoHook
		...
		//return result;
		//else
        return result + mOppoExtraConfiguration.hashCode();
	 	//#endif /* VENDOR_EDIT */
