...
public class Editor {
    ...
    private void chooseSize(PopupWindow pop, CharSequence text, TextView tv) {
        ...
        */
        //#else /* VENDOR_EDIT */
        Layout l = new OppoStaticLayout(text, tv.getPaint(), defaultWidthInPixels,
                                    Layout.Alignment.ALIGN_NORMAL, 1, 0, true);           
        //#endif /*VENDOR_EDIT*/
        float max = 0;
     ...
     */
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.CHANGE_CODE_AND_ACCESS,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK : -private: modify for OppoEditor")
    boolean selectCurrentWord() {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhua.Lin@Plf.Framework.SDK, 2013-07-25 : Modify for OppoEditor
        if (this instanceof OppoEditor) {
            if(((OppoEditor)this).isAllTextSelected()) {
                selectionStart = 0;
                selectionEnd = mTextView.length();
            }
        }
        //#endif /*VENDOR_EDIT*/
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK : -private: Modify for OppoEditor")   
    boolean isPositionVisible(int positionX, int positionY) {
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK : -private: Modify for OppoEditor")
    boolean isPositionOnText(float x, float y) {
        Layout layout = mTextView.getLayout();
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK : -private: modify for OppoEditor")
    boolean isCursorInsideEasyCorrectionSpan() {
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK : -private: Modify for OppoEditor")
    void updateCursorPosition(int cursorIndex, int top, int bottom, float horizontal) {
...
//Jianhua.Lin@Plf.Framework.SDK, 2013-07-25 : Modify for OppoEditor
    ...
    boolean onTouchEventWrap(MotionEvent event) {
        return false;
    }
//#endif /*VENDOR_EDIT*/
}
