...
//#ifdef VENDOR_EDIT
//#@OppoHook
//#JinPeng@Plf.Framework.SDK, 2013/08/16, Add for
import android.text.OppoStaticLayout;
//#endif /*VENDOR_EDIT*/
...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
 ...
 @android.annotation.OppoHook(
            ...
            note="yangguofu@EXP.SysFramework.frameworks, Add for line add friends thai string error bugid:290086")    
//#ifdef VENDOR_EDIT
//#@OppoHook
  private String lineAppErrorStringAvoid(CharSequence text)
    {
    	int len = text.length();
    	if (len < 3 ) {
			return null;
    	...
    	boolean haseSpecialOrder = false;
    	boolean lastIsSpecial = false;
    	char lastch  = text.charAt(0);
    	...
    	for (int i = 0; i < len; i++) {
			...
			case 0x0e37: //
				if (lastIsSpecial) {
					sBuilder.append(ch);
					sBuilder.append(lastch);
					haseSpecialOrder = true;
				}
				else 
				{
					sBuilder.append(ch);
    	...
    	return haseSpecialOrder?sBuilder.toString():null;
    }    
//#endif /* VENDOR_EDIT */
    ...
    @android.annotation.OppoHook(
            ...
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="LiHu@APP.EXP, add for display emoji surpport")
    private void setText(CharSequence text, BufferType type,
        ...
        //#ifdef VENDOR_EDIT
        //yangguofu@EXP.SysFramework.frameworks, 2013/06/18,  for line add friends thai string error bugid:290086
        if(null != text)
        {
            String txtchange = lineAppErrorStringAvoid(text);
            if(null != txtchange)
            {
                text = txtchange;
            }
        ...
        // #ifdef VENDOR_EDIT
        // LiHu@APP.EXP, 2013/08/21, Add for emoji surpport
        if (mEmojiEnabled) {
           mTransformed = OppoEmojiPlugin.getInstance(mContext)
                   .refreshEmojiOfText(text, mTransformation, mTransformed, TextView.this, mSpannableFactory);
        }
        //#endif /* VENDOR_EDIT */
        ...
        if (mHint != null) {
            ...
            if (hintBoring != null) {
                if (hintBoring.width <= hintWidth &&
                    ...
                    //#ifdef VENDOR_EDIT
                    //#@OppoHook
                    //#JinPeng@Plf.Framework.SDK, 2013/08/16, Modify for OppoStaticLayout
                    /*
                    ...
                    */
                    //#else /* VENDOR_EDIT */
                    mHintLayout = new OppoStaticLayout(mHint,
                                0, mHint.length(),
                                mTextPaint, hintWidth, alignment, mTextDir, mSpacingMult,
                                mSpacingAdd, mIncludePad, mEllipsize,
                                ellipsisWidth, mMaxMode == LINES ? mMaximum : Integer.MAX_VALUE);
                    ...
                    */
                    //#else /* VENDOR_EDIT */
                    mHintLayout = new OppoStaticLayout(mHint, mTextPaint,
                            hintWidth, alignment, mTextDir, mSpacingMult, mSpacingAdd,
                            mIncludePad);
                    //#endif /*VENDOR_EDIT*/
                }
        ...
        if (mText instanceof Spannable) {
            ...
            if (boring != null) {
                if (boring.width <= wantWidth &&
                    ...
                    */
                    //#else /* VENDOR_EDIT */
                    result = new OppoStaticLayout(mTransformed,
                            0, mTransformed.length(),
                            mTextPaint, wantWidth, alignment, mTextDir, mSpacingMult,
                            mSpacingAdd, mIncludePad, effectiveEllipsize,
                            ellipsisWidth, mMaxMode == LINES ? mMaximum : Integer.MAX_VALUE);
                    ...
                    */
                    //#else /* VENDOR_EDIT */
                    result = new OppoStaticLayout(mTransformed, mTextPaint,
                            wantWidth, alignment, mTextDir, mSpacingMult, mSpacingAdd,
                            mIncludePad);
                    //#endif /*VENDOR_EDIT*/
                }
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhua.Lin@Plf.Framework.SDK, Modify for OppoEditor
        /*
        if (mEditor != null) mEditor.onTouchEvent(event);
        */
        //#else /* VENDOR_EDIT */
        if (mEditor != null) {
            if (mEditor.onTouchEventWrap(event)) {
                return true;
            }
        }
        //#endif /*VENDOR_EDIT*/
    ...
    private void createEditorIfNeeded() {
        if (mEditor == null) {
            //#ifdef VENDOR_EDIT
            //#@OppoHook
            //Jianhua.Lin@Plf.Framework.SDK, 2013-07-25, Modify for creating OppoEditor instead of Editor
            /*
            mEditor = new Editor(this);
            */
            //#else /* VENDOR_EDIT */
            mEditor = new OppoEditor(this);
            //#endif /*VENDOR_EDIT*/
        }
    }
    ...
    private class ChangeWatcher implements TextWatcher, SpanWatcher {
        ...
        public void onTextChanged(CharSequence buffer, int start, int before, int after) {
            ...
            // LiHu@APP.EXP, 2013/08/21, Add for emoji surpport
            if (mEmojiEnabled) {
                CharSequence temp = OppoEmojiPlugin.getInstance(mContext)
                        .refreshEmojiOfText(buffer, mTransformation, mTransformed, TextView.this, mSpannableFactory);
                if (mTransformed != temp) {
                    mTransformed = temp;
...
//#ifdef VENDOR_EDIT
//#@OppoHook
//#JinPeng@Plf.Framework.SDK, 2013/07/15, Add for
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_FIELD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK")
    private EditToolBarActionListener mEditToolBarActionListener;

    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK, monitor the behavior on the EditToolbar")
    public void setEditToolBarActionListener(EditToolBarActionListener listener) {
        mEditToolBarActionListener = listener;
    }
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK, monitor the behavior on the EditToolbar")
    public boolean isHandleEditAction(int flag) {
        if (null != mEditToolBarActionListener) {
            if (flag == OppoEditorHelper.COPY_ACTION) {
                mEditToolBarActionListener.onCopyButtonDown();    
            } else if (flag == OppoEditorHelper.Paste_ACTION) {
                return mEditToolBarActionListener.onPasteButtonDown();    
            } else if (flag == OppoEditorHelper.CUT_ACTION) {
                //mEditToolBarActionListener.onCutButtonDown();    
            }
            return true;
        } else {
            return false;
    ...
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.QCOM,
            note = "JinPeng@Plf.Framework.SDK, Add for monitor the touch behavior")
    public void setEditFlag(int flag) {
        if (mEditor instanceof OppoEditor) {
            ((OppoEditor)mEditor).setEditFlag(flag);
        }
    }
    ...
    public void setOnTouchListener(OnTouchListener l) {
        ...
        if (mEditor instanceof OppoEditor) {
            OppoEditor editor = (OppoEditor)mEditor;
            if (l != null) {
                editor.setHasOnTouchListener(true);
            } else {
                editor.setHasOnTouchListener(false);
            }
        }
    }

    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_CLASS,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK")
    public interface EditToolBarActionListener {
        boolean onPasteButtonDown();
        void onCopyButtonDown();
        //void onCutButtonDown();
    }
//#endif /*VENDOR_EDIT*/
    ...
    @android.annotation.OppoHook(
            ...
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="LiHu@APP.EXP, add for display emoji surpport")
	protected boolean mEmojiEnabled = true;
	
    @android.annotation.OppoHook(
            level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="LiHu@APP.EXP, add for display emoji surpport")
	public final void setEmojiEnabled(boolean flag) {
		if (DEBUG_EXTRACT) {
			Log.i(LOG_TAG, "setEmojiEnabled, flag = " + flag);
		}

		if (mEmojiEnabled != flag) {
			mEmojiEnabled = flag;
			if (flag) {
				CharSequence temp = OppoEmojiPlugin.getInstance(mContext)
						.refreshEmojiOfText(mText, mTransformation, mTransformed, TextView.this, mSpannableFactory);
				if (mTransformed != temp) {
					mTransformed = temp;
					if (mLayout != null)
						checkForRelayout();
				...
				if (mTransformation == null) {
					...
					mTransformed = mTransformation.getTransformation(mText, TextView.this);
				}
				if (mLayout != null)
					checkForRelayout();
			}
