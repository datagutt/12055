...
public class RemoteViews implements Parcelable, Filter {
    ...
    private RemoteViews(Parcel parcel, BitmapCache bitmapCache) {
        ...
        if (mode == MODE_NORMAL) {
            ...
            //#ifdef VENDOR_EDIT
            //Shaofeng.Ding@Prd.DesktopApp.Launcher, 2013/01/03, Add for OPPO AppWidget
            int customer = parcel.readInt();
            if (customer == 1) {
                mHasUsedCustomerView = true;
            } else {
                mHasUsedCustomerView = false;
            }
            //#endif /* VENDOR_EDIT */
    ...
    public View apply(Context context, ViewGroup parent, OnClickHandler handler) {
        ...
        //#ifndef VENDOR_EDIT
        //Shaofeng.Ding@Prd.DesktopApp.Launcher, 2012/06/20, Modify for Oppo AppWidget
        /*
        inflater.setFilter(this);
        */
        //#else /* VENDOR_EDIT */
        if(!this.mHasUsedCustomerView){
			inflater.setFilter(this);
		}        
        //#endif /* VENDOR_EDIT */
    ...
    private Context prepareContext(Context context) {
        ...
        if (packageName != null) {
            try {
                ...
                //#ifndef VENDOR_EDIT
                //Shaofeng.Ding@Prd.DesktopApp.Launcher, 2013/01/23, Modify for 
                /*
                c = AppWidgetContext.newWidgetContext(context, packageName, mHasUsedCustomerView);
                */
                //#else /* VENDOR_EDIT */
                if(mHasUsedCustomerView){
    ...
    public void writeToParcel(Parcel dest, int flags) {
        if (!hasLandscapeAndPortraitLayouts()) {
            ...
            //#ifdef VENDOR_EDIT
            //Shaofeng.Ding@Prd.DesktopApp.Launcher, 2013/01/03, Add for OPPO AppWidget
            dest.writeInt((mHasUsedCustomerView ? 1 : 0));    
            //#endif /* VENDOR_EDIT */
