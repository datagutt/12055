...
//#ifdef VENDOR_EDIT
//Liangjing.Fu@Plf.Framework.SDK, 2013/01/21 Add for spring effect
import android.util.DisplayMetrics;
import android.view.OppoViewConfiguration;
...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    public AbsListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //LiangJing.Fu@Plf.Framework.SDK, 2013/01/21, Add for initialization oppo property
    ...
    private void scrollIfNeeded(int y) {
        ...
        if (mTouchMode == TOUCH_MODE_SCROLL) {
            ...
            if (y != mLastY) {
                ...
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //LiangJing.Fu@Plf.Framework : modify for re-calculate the overscroll distance
                /*
                    int overScrollDistance = -incrementalDeltaY;
                */
                int overScrollDistance = calcRealOverScrollDist(-incrementalDeltaY);
                //#else /* VENDOR_EDIT */
                ...
                if (overScrollDistance != 0) {
                    ...
                    if (overscrollMode == OVER_SCROLL_ALWAYS ||
                        ...
                        if (rawDeltaY > 0) {
                            ...
                            //#ifndef VENDOR_EDIT
                            //#@OppoHook
                            //LiangJing.Fu@Plf.Framework.SDK, 2013/03/12,shield android original code:
                            /*
                            invalidate(mEdgeGlowTop.getBounds(false));
                            */
                            //#endif /* VENDOR_EDIT */
                            ...
                            //LiangJing.Fu@Plf.Framework.SDK, 2013/03/12,shield android original code:
                            /*
                            invalidate(mEdgeGlowTop.getBounds(true));
                            */
                            //#endif /* VENDOR_EDIT */
                        }
                        //#ifdef VENDOR_EDIT
                        //#@OppoHook
                        //LiangJing.Fu@Plf.Framework.SDK, 2013-03-12 add for invalidate the whole ListView instead of partial update, for we enabled over scroll
                        invalidate();
                        //#endif /* VENDOR_EDIT */
                    }
                }
    ...
    public void draw(Canvas canvas) {
        ...
        //#ifndef VENDOR_EDIT
        //#@OppoHook
        //LiangJing.Fu@Plf.Framework.SDK, Add for ignore EdgeEffect if is oppoStyle 2013/08/02
        /*
        if (mEdgeGlowTop != null) {
        */
        //#else /* VENDOR_EDIT */
        if (mEdgeGlowTop != null && !getContext().isOppoStyle()) {
        //#endif VENDOR_EDIT
            final int scrollY = mScrollY;
            if (!mEdgeGlowTop.isFinished()) {
    ...
    @android.annotation.OppoHook(
        ...
        FlingRunnable() {
            //#ifndef VENDOR_EDIT
            //#@OppoHook
            //LiangJing.Fu@Plf.Framework : modify for mScroller of OppoOverScroller
            /*
                mScroller = new OverScroller(getContext());
            */
            //#else /* VENDOR_EDIT */
            mScroller = OppoOverScroller.newInstance(getContext());
            //#endif /* VENDOR_EDIT */
        }
        ...
        public void run() {
            ...
            case TOUCH_MODE_FLING: {
                ...
                if (more && !atEnd) {
                    ...
                    mLastFlingY = y;
                    //#ifndef VENDOR_EDIT
                    //LiangJing.Fu@Plf.Framework.SDK, 2013/07/12 add for use the main thread when scrolling
                    /*
                    postOnAnimation(this);
                    */
                    //#else
...
//#ifdef VENDOR_EDIT
//Jianjun.Dan@Plf.Framework.SDK, 2013/07/25, Add  for merge oppolistview;
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhua.Lin@Plf.Framework.SDK,2013-04-08,Modify for the effect of listview fling")
    @Override
    public void computeScroll() {
        if(mTouchMode == TOUCH_MODE_FLING && mFlingRunnable != null) {
            mFlingRunnable.run();
        }
    }
    ...
    public void initOppoProperty(Context context){
        if(context.isOppoStyle()){
            final OppoViewConfiguration configuration = OppoViewConfiguration.get(mContext);
            final Resources res = context.getResources();
            final DisplayMetrics metrics = res.getDisplayMetrics();
            mOverflingDistance = mOverscrollDistance = metrics.heightPixels / 2;
        }
        mOppoHooks = new OppoListViewHooks(this);
    }
    
    /**
     * Re-calculate the overscroll distance, add a friction to the move, the friction
     * depends on the current scrollY, farther away from the edge, larger the friction is.
     * 
     * @param dist the original distance.
     * @return the distance after re-calculated.
     */
    @android.annotation.OppoHook(
            level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property=android.annotation.OppoHook.OppoRomType.ROM,
...
//#endif /* VENDOR_EDIT */
	...
	/*OPPO 2012/07/16 luoyaojun add end.*/
//Jianhui.Yu@Plf.Framework.SDK, 2013-07-25, Add for list remove animation
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_FIELD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhui.Yu@Plf.Framework.SDK, Add for list remove animation")
    /** @hide */
    public OppoListViewHooks mOppoHooks = null;
//#endif /* VENDOR_EDIT */
}
