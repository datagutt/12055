...
public class ScrollView extends FrameLayout {
    ...
    public void draw(Canvas canvas) {
		...
		//#ifdef VENDOR_EDIT
		//#@OppoHook
		//JiangJing.Fu@Plf.Framework.SDK, Add for ignore EdgeEffect if is oppoStyle 2013/07/16
        //if (mEdgeGlowTop != null) {
        //#else /* VENDOR_EDIT */
        if (mEdgeGlowTop != null && false == getContext().isOppoStyle()) {
		// #endif VENDOR_EDIT	
            final int scrollY = mScrollY;
            if (!mEdgeGlowTop.isFinished()) {
    ...
    private void initOppoProperty(Context context){
        boolean isOppoStyle= context.isOppoStyle();
        if(isOppoStyle){
