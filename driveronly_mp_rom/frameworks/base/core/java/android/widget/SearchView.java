...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianjun.Dan@Plf.Framework.SDK  adapted for OppoStyle 
    ...
    private CharSequence getDecoratedHint(CharSequence hintText) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianjun.Dan@Plf.Framework.SDK : SearchView adapted for OppoStyle
...
//Jianjun.Dan@Plf.Framework.SDK : SearchView adapted for OppoStyle
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianjun.Dan@Plf.Framework.SDK : SearchView adapted for OppoStyle ")
    private boolean isHintTextSize = true;
    ...
    private void changeTextSize(String newText) {
        ...
        if (newText.isEmpty()) {
            mQueryTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,mContext.getResources().getDimensionPixelSize(
                    oppo.R.dimen.oppo_searchview_text_hint_size));
            isHintTextSize = true;
        } else if (isHintTextSize) {
            mQueryTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,mContext.getResources().getDimensionPixelSize(
                    oppo.R.dimen.oppo_searchview_text_size));
            isHintTextSize = false;
        }
    }
//#endif /* VENDOR_EDIT */
}
