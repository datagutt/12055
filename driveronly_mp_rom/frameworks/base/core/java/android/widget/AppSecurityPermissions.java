...
public class AppSecurityPermissions {
    ...
    static class MyPermissionGroupInfo extends PermissionGroupInfo {
        ...
        public Drawable loadGroupIcon(PackageManager pm) {
            if (icon != 0) {
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //YongDong.Zhang@Plf.Framework.SDK, 2013-08-22 : Modify for make convertIcon useless here
                /*
                     return loadIcon(pm);
                */
                //#else /* VENDOR_EDIT */
                ...
                try {
                    ...
                    */
                    //#else /* VENDOR_EDIT */
                         return appInfo.loadIcon(pm, false);
                    //#endif /* VENDOR_EDIT */
    ...
    public AppSecurityPermissions(Context context, List<PermissionInfo> permList) {
		...
		//#ifdef VENDOR_EDIT
		//tianyang.lu@PersonalApp, 2013/04/11, Add for Android source bug
    ...
    private void setPermissions(List<MyPermissionInfo> permList) {
        if (permList != null) {
            ...
            for (MyPermissionInfo pInfo : permList) {
                ...
                //#ifdef VENDOR_EDIT
                //tianyang.lu@PersonalApp, 2013/04/11, Add for Android source bug. Always load the permissions, even though the group is null
                else{
                    //group == null
                    if(localLOGV) Log.i(TAG, "group == null");
                    pInfo.mLabel = pInfo.loadLabel(mPm);
                    group = new MyPermissionGroupInfo((PermissionInfo)pInfo);
                    addPermToList(group.mAllPermissions, pInfo);
                    if (pInfo.mNew) {
                        addPermToList(group.mNewPermissions, pInfo);
                    }
                    ...
                    mPermGroups.put(pInfo.group, group);
                }
                //#endif /*VENDOR_EDIT*/
            }
        }
