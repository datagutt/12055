...
public class ListView extends AbsListView {
    ...
    private View fillSpecific(int position, int top) {
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013-07-24 : Add for list remove animation
        if (mOppoHooks.mRemoveImpl.hasRemovedItems()) {
            return mOppoHooks.mRemoveImpl.fillSpecific(position, top);
        }
        //#endif /* VENDOR_EDIT */
