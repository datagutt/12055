...
public class SeekBar extends AbsSeekBar {
    ...
    //#ifdef VENDOR_EDIT
    //YongDong.Zhang@Prd.MidWare.Res, 2013/03/23, Add for make half thumb will invisible according to oppo`s UI
    if (context.isOppoStyle() && null != getThumb()) {
         int padding = (int)context.getResources().getDimension(com.android.internal.R.dimen.oppo_seekbar_thumb_offset);
