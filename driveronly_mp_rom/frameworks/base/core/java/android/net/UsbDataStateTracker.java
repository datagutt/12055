...
public class UsbDataStateTracker implements NetworkStateTracker {
    ...
    private static final String USB_IFACE_ADDR      = "192.168.0.100";
    private static final int USB_PREFIX_LENGTH        = 24;
    private static final String DEFAULT_DNS1        = "192.168.0.1";
    ...
    private class UsbDataStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("mediatek.intent.action.USB_DATA_STATE")) {
                ...
                if (mUsbDataState != state) {
                    ...
                    switch (state) {
                        ...
                        case CONNECTED:
                            ...
                            mLinkProperties.addDns(NetworkUtils.numericToInetAddress(DEFAULT_DNS1));
                ...
                if (VDBG) Slog.d(TAG, mApnType + " got ACTION_DATA_CONNECTION_TRACKER_MESSENGER");
                mMessenger = intent.getParcelableExtra(DataConnectionTracker.EXTRA_MESSENGER);
                AsyncChannel ac = new AsyncChannel();
                ac.connect(mContext, UsbDataStateTracker.this.mHandler, mMessenger);
                    ...
                    equals(UsbManager.ACTION_USB_STATE)) {
            ...
            for (String iface : ifaces) {
                if (isUsb(iface)) {
                    ...
                    try {
                        ...
                        if (ifcg != null) {
                            InetAddress addr = NetworkUtils.numericToInetAddress(USB_IFACE_ADDR);
