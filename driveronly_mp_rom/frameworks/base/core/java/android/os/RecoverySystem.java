...
//#ifdef VENDOR_EDIT
//rendongn.shi@Basic.drv, 2012/02/21, Add for preloader switch 
...
public class RecoverySystem {
    ...
    public static void rebootWipeUserData(Context context) throws IOException {
        ...
        //#ifdef VENDOR_EDIT//Jinquan.Lin@BasicDrv.BL, 2012/05/18, Add for customizing OPPO_CUSTOM partition!
		if( 1 == OppoUtils.CustPartConfigItemUsbOps(true, 0, 1) )
        {
            OppoUtils.CustPartConfigItemUsbOps(false, 0, 1);
        }
