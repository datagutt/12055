...
//#ifndef VENDOR_EDIT
//Zhanhong.Hu@Prd.SystemSrv.AMS, 2012/12/30, Modify for make sure the datastream was completely read.
        /*
            if (result.pid < 0) {
...
//#endif /* VENDOR_EDIT */
	...
	/**
    * Chenps@OnLineRD.Framework.BPM,2013/01/17       
    * {@hide}
    */
    ...
    public static final native boolean isProcessSuspend(int pid);
	//#endif /* VNEDOR_EDIT */
}
