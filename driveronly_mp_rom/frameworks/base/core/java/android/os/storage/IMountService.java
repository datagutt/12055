...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            /**
             * Use for SD swap feature only
             * Exchange SD
             */
            public boolean isSDExist() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_isSDExist, _data, _reply, 0);
                    _reply.readException();
                    _result = 0 != _reply.readInt();
                } finally {
                    _reply.recycle();
        ...
        static final int TRANSACTION_isSDExist = IBinder.FIRST_CALL_TRANSACTION + 35;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                case TRANSACTION_isSDExist: {
                    data.enforceInterface(DESCRIPTOR);
                    boolean result = isSDExist();
                    reply.writeNoException();
                    reply.writeInt((result ? 1 : 0));
                    return true;
                }
