...
public class BatteryManager {
    ...
    //#ifdef VENDOR_EDIT
    //Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/01/23, Add for 
    /**     
    * Extra for {@link android.content.Intent#ACTION_BATTERY_CHANGED}:     
    * String describing the charger voltage of the current battery.  
    * {@hide}  
    */    
    public static final String EXTRA_CHGERVOL = "chgervol";	    

    /**     
    * Extra for {@link android.content.Intent#ACTION_BATTERY_CHANGED}:     
    * String describing the chging current of the current battery.   
    * {@hide}  
    */    
