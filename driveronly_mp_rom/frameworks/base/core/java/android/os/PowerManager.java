...
public final class PowerManager {
    ...
    /**
     * Go to sleep reason code: Going to sleep due to a proximity sensor.
     * @hide
     */
    public static final int GO_TO_SLEEP_REASON_PROX_SENSOR = 3;
    //#endif /* VENDOR_EDIT */
...
//Jianrong.Zheng@Prd.BasicSrv.BatteryManager, 2013/01/26, Add for 
    /**
     * get the brightness of the Screenbacklights .
     *
     * @return current brightness of Lcd (from 20 to 255).
	   * 
     */    
     public int getLcdBrightness()
    {
        try {
            return mService.getLcdBrightness();
        } catch (RemoteException e) {
        	return -1;
        }
    }
//#endif /* VENDOR_EDIT */
    ...
    public void syncProximityPositiveState(boolean positive) {
        try {
            mService.syncProximityPositiveState(positive);
        } catch (RemoteException e) {
        }
    }
    //#endif /* VENDOR_EDIT */
    ...
    /**
     * Returns true if Proximity work and Positive.
     *
     *
     * {@hide}
     */
    public boolean bIsScreenOffBecauseOfProximityPositive() {
        try {
            return mService.bIsScreenOffBecauseOfProximityPositive();
        } catch (RemoteException e) {
            return false;
        }
    }    
...
//JiangLin.Ma@Prd.SysApp.Settings, 2013/03/30, Add for 
    public int getBatteryLevel() {
        try {
            return mService.getOppoBatteryLevel();
        } catch (RemoteException e) {
            return -1;
        }
    }
