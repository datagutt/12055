...
//#ifdef VENDOR_EDIT
//SheTao@Prd.BasicSrv.PowerManager, 2012/07/30, Add for 
import android.oppoutils.OppoUtils;//mingqiang.guo@Prd.BasicDrv.Sensor add for ps recover send pulse count
//import android.oppoutils.OppoUtils;//mingqiang.guo@Prd.BasicDrv.Sensor add for ps recover send pulse count
//#endif /* VENDOR_EDIT */
/**
    ...
    public SystemSensorManager(Looper mainLooper) {
        ...
        synchronized(sListeners) {
            if (!sSensorModuleInitialized) {
                ...
                //SheTao@Prd.BasicSrv.PowerManager, 2012/07/30, Add for                 
		  		//modify by linzy
				//RUtils.RUtilsCustPartCustPartRecoverGsensorData();   
		  		OppoUtils.CustPartCustPartRecoverGsensorData(); 
                OppoUtils.CustPartCustPartAlsPsRecoverPsSendPulse();//mingqiang.guo@Prd.BasicDrv.Sensor add for ps recover send pulse count                                    
                OppoUtils.CustPartCustPartAlsPsRecoverPsSwitch();//LiuPing@Prd.BasicDrv.Sensor, add 2012/12/05  for ps switch                 
                //#endif /* VENDOR_EDIT */
            }
        }
    }
