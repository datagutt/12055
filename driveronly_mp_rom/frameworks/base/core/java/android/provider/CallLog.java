...
public class CallLog {
    ...
    //#ifdef VENDOR_EDIT
   //ChengJun.Duan@Prd.CommApp.Phone, 2012/07/03, Add for 
        public static final String PRIVATE_TYPE = "private_type";
        public static final String PRIVATE_NAME = "private_name";
		// MengQing.Zhong@Prd.CommApp.OppoDialer, 2013/03/28, Add for CallLog sliding
        public static final String PHONENO_AREA = "phoneno_area";
    //#endif /* VENDOR_EDIT */
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
            ...
            if (ci != null) {
                //#ifndef VENDOR_EDIT
                //MengQing.Zhong@Prd.CommApp.OppoDialer, 2012/10/30, Modify for do not insert name when caller is EmergencyNumber
                /*
            ...
            //#ifdef VENDOR_EDIT
            //BaoZhu.Yu@Prd.CommApp.Telephony, 2012/05/09, Add for 
            values.put(CACHED_PHOTO_ID, ci.oppoPhoto_id);
            //#endif /* VENDOR_EDIT */ 
            }
            /// M: @{
         ...
         */
        public static Uri addCall(CallerInfo ci, Context context, String number,
                int presentation, int callType, long start, int duration, int simId, int vtCall, String phoneNOArea ) {
            final ContentResolver resolver = context.getContentResolver();
            ...
            values.put(DURATION, Long.valueOf(duration));
            values.put(NEW, Integer.valueOf(1));
			values.put(PHONENO_AREA, phoneNOArea);
            if (callType == MISSED_TYPE) {
                values.put(IS_READ, Integer.valueOf(0));
            }
            if (ci != null) {
...
//ChengJun.Duan@Prd.CommApp.Phone, 2012/07/03, Add for 
         ...
         * @param start time stamp for the call in milliseconds
         * @param duration call duration in seconds
         * @param protect is protected by safemanager
		 *
         * {@hide}
         */
		//#ifndef VENDOR_EDIT
		// MengQing.Zhong@Prd.CommApp.OppoDialer, 2013/03/28, Modify for CallLog sliding
        /*public static Uri addCall(CallerInfo ci, Context context, String number, String private_name,
                int presentation, int callType, long start, int duration, int simId, int vtCall, int private_type) {
		*/
		//#else /* VENDOR_EDIT */
        public static Uri addCall(CallerInfo ci, Context context, String number, String private_name,
                int presentation, int callType, long start, int duration, int simId, int vtCall, int private_type, String phoneNOArea) {
		...
		//#endif /* VENDOR_EDIT */
            ...
            // MTK new feature:IP dial enhancement start
            String ipPrefix = null;
            if (FeatureOption.MTK_GEMINI_SUPPORT) {
                ipPrefix = Settings.System.getString(resolver, "ipprefix" + simId);
            } else {
            ...
            // MTK new feature:IP dial enhancement end
			//#ifndef VENDOR_EDIT
			// MengQing.Zhong@Prd.CommApp.OppoDialer, 2013/03/28, Add for CallLog sliding
            values.put(PHONENO_AREA, phoneNOArea);
			//#endif /* VENDOR_EDIT */
