...
public class InputMethodService extends AbstractInputMethodService {
    ...
    @Override public void onCreate() {
		//#ifndef VENDOR_EDIT
		// QinXin@Prd.MidWare.IME, 2012/08/16, Modify for fullscreen inputmethod theme
		//fulj@Plf.Framework.IMS, upgrade android4.1 2012-09-22
		/*
		...
		*/
		//#else
				mTheme = oppo.R.style.Theme_OPPO_InputMethod;
		//#endif /* VENDOR_EDIT */
    ...
    public View onCreateExtractTextView() {
		...
		*/
		//#else
				return mInflater.inflate(
						com.android.internal.R.layout.oppo_input_method_extract_view, null);
		//#endif /* VENDOR_EDIT */
