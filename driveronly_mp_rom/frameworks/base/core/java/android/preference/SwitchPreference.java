...
public class SwitchPreference extends TwoStatePreference {
    ...
    protected void onBindView(View view) {
        ...
        if (checkableView != null && checkableView instanceof Checkable) {
            //#ifdef VENDOR_EDIT
            //#@OppoHook
            //wangw@OnlineRd.SDK.framework, 2013-04-10 : Add for fix bug
                //when click the compoundButton but 
                //not the SwitchPreference ,checkedChangeListener will change checked state 
                //back to before it was clicked, which is not wanted
