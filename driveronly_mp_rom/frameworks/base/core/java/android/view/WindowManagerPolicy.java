...
public interface WindowManagerPolicy {
    ...
    public interface WindowState {
        ...
        //#ifdef VENDOR_EDIT
		//Yingli.Wang@Plf.DesktopApp.Keyguard, 2012/10/18, Add for apk lockscreen
        /**
         * Retrieve the curren window's parent window.
         * 
         * @return WindowState The curren window's parent window
         */
    ...
    public interface WindowManagerFuncs {
		...
		//#ifdef VENDOR_EDIT
		//@OppoHook
		//yaolang@Plt.Framewrok, add for OPPO global actions.
		public void reboot();
		//#endif /* VENDOR_EDIT */
	...
	//#ifdef VENDOR_EDIT
	//Jiangtao.Guo@Prd.SysSrv.InputManager, 2012/11/14, Add for [statusBar], {
	/**
	* 
	* {@hide}
	*/	
	...
	@android.annotation.OppoHook(level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
			property = android.annotation.OppoHook.OppoRomType.ROM,
			note = "hejiamiao add for pull down status bar when full screen")
	void rm_add_StatusBarRunnable(int type);
	//} add end for [].
	//#endif /* VENDOR_EDIT */
	
   	//#ifdef VENDOR_EDIT
	//HuangYuan@Prd.DesktopApp.Keyguard, 2012/06/06, Add for apk lockscreen
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      note="zhangkai add for apklock") 
