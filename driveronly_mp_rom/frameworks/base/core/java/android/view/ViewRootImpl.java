...
public final class ViewRootImpl implements ViewParent,
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_ACCESS,
		                      ...
		                      note="private: modify for OppoPasswordEntryKeyboardHelper")
    public final static int MSG_DISPATCH_KEY = 7;
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_ACCESS,
	                          property=android.annotation.OppoHook.OppoRomType.ROM,
		                      note="private: modify for OppoPasswordEntryKeyboardHelper")
    public final static int MSG_DISPATCH_KEY_FROM_IME = 11;
    ...
    final class ViewRootHandler extends Handler {
	   ...
	   @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_CODE,
		                property=android.annotation.OppoHook.OppoRomType.ROM,
				  note="Zhichao.Fan@Plf.Framework, add for avoid NullPointer Exception")
        @Override
        public void handleMessage(Message msg) {
            ...
            case MSG_INVALIDATE_WORLD: {
            	  //#@OppoHook
            	  //Zhichao.Fan@Plf.Framework, 2013/03/22, add for avoid NullPointerException
            	  if(mView == null)
            	  {
            	      sendMessageDelayed(obtainMessage(msg.what, msg.arg1, msg.arg2), 200);
            	      return;
            	  }
    ...
    private void deliverPointerEvent(QueuedInputEvent q) {
		...
		//#ifdef VENDOR_EDIT
		//#@OppoHook
        //Jun.Zhang@Plf.Framework, 2013/02/19, add for three pointers move shot screen
		if (OppoScreenShotUtil.checkPauseDeliverPointer()){
			OppoScreenShotUtil.dealPausedDeliverPointer((MotionEvent)q.mEvent, mView);
