...
public class StaticLayout extends Layout {
    ...
    public final Directions getLineDirections(int line) {
        ...
        //#else /* VENDOR_EDIT */
        return getOppoHookLineDirections(line);
        //#endif /*VENDOR_EDIT*/
    }
...
//#ifdef VENDOR_EDIT
//#@OppoHook
//JinPeng@Plf.Framework.SDK, Add for OppoStaticLayout
    @android.annotation.OppoHook(
            level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="JinPeng@Plf.Framework.SDK, Add for OppoStaticLayout")
    /* package */ void oppoGenerate(CharSequence source, int bufStart, int bufEnd,
                        TextPaint paint, int outerWidth,
                        TextDirectionHeuristic textDir, float spacingmult,
                        float spacingadd, boolean includepad,
                        boolean trackpad, float ellipsizedWidth,
    ...
    @android.annotation.OppoHook(
            ...
            property=android.annotation.OppoHook.OppoRomType.ROM,
            note="JinPeng@Plf.Framework.SDK, Add for OppoStaticLayout")
    public Directions getOppoHookLineDirections(int line) {
        return mLineDirections[line];
    }
//#endif /*VENDOR_EDIT*/
}
