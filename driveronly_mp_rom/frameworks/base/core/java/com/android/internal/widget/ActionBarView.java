...
public class ActionBarView extends AbsActionBarView {
    ...
    @android.annotation.OppoHook(
            ...
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhui.Yu@Plf.Framework.SDK : Modify for oppoStyle ActionBarTitle")
    public void setDisplayOptions(int options) {
        ...
        if ((flagsChanged & DISPLAY_RELAYOUT_MASK) != 0) {
            ...
            if (mTitleLayout != null && (flagsChanged &
                ...
                //#ifndef VENDOR_EDIT
                //#@OppoHook
                //Jianhui.Yu@Plf.Framework.SDK, 2013/07/29, Modify for oppoStyle ActionBarTitle
                /*
                    mTitleUpView.setVisibility(!showHome ? (homeAsUp ? VISIBLE : INVISIBLE) : GONE);
                */
                //#else /* VENDOR_EDIT */
                    hookSetTitleItem(showHome, homeAsUp);
                //#endif /* VENDOR_EDIT */
...
//#ifdef VENDOR_EDIT
//Jianhui.Yu@Plf.Framework.SDK, 2013/07/29, Add for oppoStyle ActionBarTitle
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
            note = "Jianhui.Yu@Plf.Framework.SDK : Add for oppoStyle ActionBarTitle")
    void hookSetTitleItem(boolean showHome, boolean homeAsUp) {
        mTitleUpView.setVisibility(!showHome ? (homeAsUp ? VISIBLE : INVISIBLE) : GONE);
    }
//#endif /* VENDOR_EDIT */
}
