            ...
            if (hasTextTitle) {
               ...
               ///M: @}
                ...
                if (mIconId > 0) {
                     ...
                     */
                    //#ifdef VENDOR_EDIT
                    //#Jianhua.Lin@Plf.Framework.SDK, 2013-08-08, Modify for the display position
...
//        }
        ...
        //#ifdef VENDOR_EDIT
        //#Jianhua.Lin@Plf.Framework.SDK, Modify for oppostyle
        setPanelBackground(contentPanel, customPanel);
        //#endif /*VENDOR_EDIT*/
    }
    ...
    void setPanelBackground(LinearLayout contentPanel, View customPanel) {
        if (mContext.isOppoStyle() && customPanel != null && contentPanel.getVisibility() != View.GONE) {
            Drawable customDrawable  = mContext.getResources().getDrawable(
                    oppo.R.drawable.oppo_popup_alertdialog_custompanel);
            Drawable contentDrawable = mContext.getResources().getDrawable(
                    oppo.R.drawable.oppo_popup_alertdialog_contentpanel);
            customPanel.setBackground(customDrawable);
            contentPanel.setBackground(contentDrawable);
        }
    }
}
