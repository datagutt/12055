...
public class ScrollingTabContainerView extends HorizontalScrollView
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013/07/29, Add for resize the max tab width
            hookResizeMaxWidth(childCount);
        //#endif /* VENDOR_EDIT */
