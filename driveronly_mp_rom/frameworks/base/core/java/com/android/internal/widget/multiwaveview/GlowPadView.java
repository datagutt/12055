...
public class GlowPadView extends View {
    ...
    private void doFinish() {
        ...
        /// M: when ACTION_CANCLE, it should not trigger event. @{
        if (!mActionCancel) {
    ...
    /**
     * M: add API to set new image(s) as handleDrawable for TE. 
     * Usage example: glowPadView.setHandleDrawableImage(R.drawable.ic_lockscreen_handle1);
     * @hide @{
     */
