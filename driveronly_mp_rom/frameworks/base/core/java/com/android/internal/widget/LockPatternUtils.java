...
public class LockPatternUtils {
    ...
    */
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      ...
		                      note="resolve LockPatternView error")
    public void saveLockPattern(List<LockPatternView.Cell> pattern, boolean isFallback) {
        this.saveLockPattern(pattern, isFallback, null);
    }
    ...
    public void saveLockPattern(List<LockPatternView.Cell> pattern, boolean isFallback, String isFallbackFor) {
        ...
        try {
            ...
            if (pattern != null) {
               ...
               //wangzequan@EXP.sysFramework.gps,modify for facelock cannot use,CTS 2013/09/16
