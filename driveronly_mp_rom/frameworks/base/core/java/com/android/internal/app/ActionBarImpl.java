...
public class ActionBarImpl extends ActionBar {
    ...
    //#ifdef VENDOR_EDIT
    //#@OppoHook
    //Jianhui.Yu@Plf.Framework.SDK, 2013/07/27, Add for ActionMode animation
    ...
    private void ensureTabsExist() {
        ...
        //#ifndef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013/07/29, Modify for oppoStyle Tab
        /*
...
//#ifdef VENDOR_EDIT
//Xiaokang.Feng@Plf.Framework.SDK, 2013/04/11, Add for oppoStyle Tab
    @android.annotation.OppoHook(
...
//Jianhui.Yu@Plf.Framework.SDK, 2013/07/26, Add for ActionMode animation
    @android.annotation.OppoHook(
            level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
            property = android.annotation.OppoHook.OppoRomType.ROM,
