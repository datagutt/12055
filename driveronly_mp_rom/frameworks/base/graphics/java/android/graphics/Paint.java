...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if(DEBUG) Log.v(TAG, "Paint onCreate inst=" + Typeface.DEFAULT.native_instance);
        native_setTypeface(mNativePaint, Typeface.DEFAULT.native_instance);
        // FlipFont }
//#endif /* VENDOR_EDIT */
    }
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if(DEBUG) Log.v(TAG, "Paint reset" + Typeface.DEFAULT.native_instance);
        // FlipFont }
//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if(DEBUG) Log.v(TAG, "Paint set" + Typeface.DEFAULT.native_instance);
        // FlipFont }
//#endif /* VENDOR_EDIT */
        if (this != src) {
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        // if no explicit typeface set, or the current typeface is like the default and we are using flipfont - set to default/flipfont
        if (mTypefaceNative == 0 || (mTypeface.isLikeDefault && Typeface.isFlipFontUsed))
            native_setTypeface(mNativePaint, Typeface.DEFAULT.native_instance);
        else
            native_setTypeface(mNativePaint, mTypefaceNative); // keep using the explicit typeface
        // FlipFont }
//#endif /* VENDOR_EDIT */
    }
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        mTypefaceNative = paint.mTypefaceNative;
        // FlipFont }
//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        if(DEBUG) Log.v(TAG, "Paint setTypeface" + Typeface.DEFAULT.native_instance);
        // FlipFont }
//#endif /* VENDOR_EDIT */
...
//HaiPing.Zhong@Prd.MidWare.Fonts, 2013/01/24, Add for Android4.2 Fonts
        // FlipFont {
        mTypefaceNative = typefaceNative;
        if (mTypefaceNative == 0)
            native_setTypeface(mNativePaint, Typeface.DEFAULT.native_instance);
        // FlipFont }
//#endif /* VENDOR_EDIT */
        return typeface;
