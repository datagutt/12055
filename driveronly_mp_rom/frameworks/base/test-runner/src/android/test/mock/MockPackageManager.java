...
public class MockPackageManager extends PackageManager {
    ...
    //#ifdef VENDOR_EDIT
    //yaoshuang.zhang@Plf.SysSrv.PMS, 2012/6/21
    /*
    @Override
    public PackageInfo getPackageInfoFromPath(String resDirName) throws NameNotFoundException {
        throw new UnsupportedOperationException();
    }
     */
    //#endif /*VENOR_EDIT*/
    ...
    //#ifdef VENDOR_EDIT
    //ZhenHai.Long@SystemSRV.PMS, 2010/03/10, add to ignore the signatures checking of some special apps (e.g nearme)
/*
	public boolean isTrustSignatureApp(String PackageName){
        throw new UnsupportedOperationException();
    }

    public int setLoginMode(String packageName, int nLoginMode){
        throw new UnsupportedOperationException();
    }
    public int getLoginMode(String packageName){
        throw new UnsupportedOperationException();
    }
 */
