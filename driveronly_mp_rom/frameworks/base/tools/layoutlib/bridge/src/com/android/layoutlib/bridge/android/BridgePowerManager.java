...
public class BridgePowerManager implements IPowerManager {
    ...
    @Override
    public int getLcdBrightness() throws RemoteException {
        // pass for now.
        return 255;
    }
    
    @Override
    public void syncProximityPositiveState(boolean positive) throws RemoteException {
    
    }
    
    @Override
    public boolean bIsScreenOffBecauseOfProximityPositive() throws RemoteException {
        return false;
    }
    //#endif /* VENDOR_EDIT */
    ...
    @Override
    public int getOppoBatteryLevel() throws RemoteException {
        // pass for now.
        return 100;
    }
    //#endif /* VENDOR_EDIT */
