...
public class IWindowManagerImpl implements IWindowManager {
	...
	*/
	...
	//} add end for [].
	//#endif /* VENDOR_EDIT */
	//WangWei@PlatformSrv.Engineer, 2012/05/31, Add for 	
	public void setEngineeringMode (boolean engineering) {		
		//
    }
	//#endif VENDOR_EDIT

	//#ifdef VENDOR_EDIT
	//wangguijie@ODesktopApp.Keyguard, 2012/12/30, Add for apk lockscreen
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      note="wangguijie add for APKlock")
	...
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      note="wangguijie add for APKlock")
	public IBinder getApkUnlockWindow() {
        return null;
    }
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
		                      note="wangguijie add for APKlock")
