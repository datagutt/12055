...
public:
    Bundle(void)
        : mCmd(kCommandUnknown), mVerbose(false), mAndroidList(false),
		  ...
		  mOppoPublic(false), mOppoPublicBaseId(2048), //add by danjianjun 2012-05-25
		  mArgc(0), mArgv(NULL),
		  mOppoPackage(false), mOppoPackageId(12)//add by danjianjun 2012-11-27
        {}
    ~Bundle(void) {}
	...
	//add by danjianjun 2012-05-25
	void setOppoPublic(const bool val) { mOppoPublic = val; }
    bool getOppoPublic() const  { return mOppoPublic; }
	void setOppoPublicBaseId(const size_t val) {  mOppoPublicBaseId = val; }
	size_t getOppoPublicBaseId(void) const { return mOppoPublicBaseId; }
    //end by danjianjun 2012-05-25
    //add by danjianjun 2012-11-27
    void setOppoPackage(const bool val) { mOppoPackage = val; }
    bool getOppoPackage() const  { return mOppoPackage; }
    void setOppoPackageId(const size_t val) {  mOppoPackageId = val; }
    size_t getOppoPackageId() const { return mOppoPackageId; }
    //end by danjianjun 2012-11-27
