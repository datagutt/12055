...
interface ITelephony {
   ...
   */
   ...
   // MVNO-API END
    ...
    boolean setLine1NumberGemini(String phoneNumber,int simId);    
    void emtDial(String telNumber);
    void emtDialGemini(String telNumber,int slotid);    
    void emtHungup(String telNumber);
    void emtHungupGemini(String telNumber,int slotid);    
    void enableEngineerTest(boolean on);        
    void cancelPrivateMissedCallsNotification();
    boolean isCuCard(String iccid);
    boolean isSupportTD();
    boolean isSupportWCDMA();
    boolean is3GSwitchVisible();
    boolean switch3GDefaultSim(int simid);

//#ifdef VENDOR_EDIT 
//Congwei.Yan@Plf.CommSrv.Telephony, 2013/01/08 Add
    ...
    int setPreferredNetworkType(int type);
    ...
    boolean getOppoAudioRecordStatus();

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add is3GButtonEnable method") */
    boolean is3GButtonEnable();

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="set phone owner number")*/	   
    boolean setLine1Number(String phoneNumber);

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add oppoGetIccLockEnabled method") */
    boolean oppoGetIccLockEnabled();

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add oppoSetIccLockEnabled method") */
    void oppoSetIccLockEnabled(boolean enabled, String password, in Message onComplete);

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add oppoSetIccLockEnabled method") */
    void oppoChangeIccLockPassword(String oldPassword, String newPassword,in Message onComplete);

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add oppoIsDialing method") */
    boolean oppoIsDialing();

    /*@+  @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add oppoGetIccPin1RetryCount method.") */
    int oppoGetIccPin1RetryCount();
