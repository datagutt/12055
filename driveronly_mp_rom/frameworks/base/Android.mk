...
oppo-framework_res_source_path := APPS/oppo-framework-res_intermediates/src
#endif /* VENDOR_EDIT */
...
#ifdef VENDOR_EDITOR canjie.zheng@platform.Srv for new kinect add 
LOCAL_SRC_FILES += core/java/com/oppo/kinect/IOppoKinectService.aidl 
LOCAL_SRC_FILES += core/java/com/oppo/kinect/IRemoteServiceCallback.aidl 
#endif canejie.zheng add end
#
...
#Jianjun.Dan@Plf.Framework.SDK			
LOCAL_INTERMEDIATE_SOURCES += \
			$(oppo-framework_res_source_path)/oppo/R.java \
			$(oppo-framework_res_source_path)/oppo/Manifest.java \
			$(oppo-framework_res_source_path)/com/oppo/internal/R.java
#endif /* VENDOR_EDIT */

LOCAL_NO_STANDARD_LIBRARIES := true
LOCAL_JAVA_LIBRARIES := bouncycastle core core-junit ext CustomProperties oppo-framework
...
# @}
#else
oppo-framework_res_R_stamp := \
	$(call intermediates-dir-for,APPS,oppo-framework-res,,COMMON)/src/R.stamp
$(full_classes_compiled_jar): $(framework_res_R_stamp) $(mediatek_res_R_stamp) $(oppo-framework_res_R_stamp)
#endif /* VENDOR_EDIT */
...
#ifndef VENDOR_EDIT
#Jianjun.Dan@Plf.Framework.SDK
$(LOCAL_INSTALLED_MODULE): | $(dir $(LOCAL_INSTALLED_MODULE))oppo-framework-res.apk
#endif /* VENDOR_EDIT */
...
LOCAL_SRC_FILES:=$(framework_docs_LOCAL_SRC_FILES)
LOCAL_INTERMEDIATE_SOURCES:=$(framework_docs_LOCAL_INTERMEDIATE_SOURCES)
LOCAL_JAVA_LIBRARIES:=$(framework_docs_LOCAL_JAVA_LIBRARIES) framework secondary-framework
LOCAL_MODULE_CLASS:=$(framework_docs_LOCAL_MODULE_CLASS)
LOCAL_DROIDDOC_SOURCE_PATH:=$(framework_docs_LOCAL_DROIDDOC_SOURCE_PATH)
LOCAL_DROIDDOC_HTML_DIR:=$(framework_docs_LOCAL_DROIDDOC_HTML_DIR)
LOCAL_ADDITIONAL_JAVA_DIR:=$(framework_docs_LOCAL_ADDITIONAL_JAVA_DIR)
...
#Jianjun.Dan@Plf.Framework.SDK 
# ============================================================
# Build secondary-framework.jar - split from framework.jar
# ============================================================
include $(CLEAR_VARS)
...
LOCAL_JAVA_LIBRARIES := bouncycastle core core-junit ext framework oppo-framework
LOCAL_JAVA_LIBRARIES += mediatek-common
