...
public class WifiManager {
    ...
    //#ifdef VENDOR_EDIT
    //YanChen@Prd.SysApp.WIFI, 2012/06/27, Add for company's signal strength standard 
    private static final int OPPO_83_MIN_RSSI     = -91;
    private static final int OPPO_83_MIDDLE1_RSSI = -80;
    private static final int OPPO_83_MIDDLE2_RSSI = -76;
    private static final int OPPO_83_MAX_RSSI     = -65;

    private static final int OPPO_39_MIN_RSSI     = -93;
    private static final int OPPO_39_MIDDLE1_RSSI = -82;
    private static final int OPPO_39_MIDDLE2_RSSI = -78;
    private static final int OPPO_39_MAX_RSSI     = -68;
    //#endif /* VENDOR_EDIT */   
    ...
    public static int calculateSignalLevel(int rssi, int numLevels) {
        //#ifndef VENDOR_EDIT 
        //Congwei.Yan@Plf.CommSrv.WLAN, 2012/08/24, modify for OPPO's signal strength standard 
        /*
        if (rssi <= MIN_RSSI) {
            return 0;
        ...
        */
        //#else
        if (numLevels == RSSI_LEVELS) {
            if(Build.MODEL.equals("R809T")) {
                if (rssi <= OPPO_83_MIN_RSSI) {
                    return 0;
                }
                else if ((rssi > OPPO_83_MIN_RSSI) && (rssi <= OPPO_83_MIDDLE1_RSSI)) {
                    return 1;
                }
                else if ((rssi > OPPO_83_MIDDLE1_RSSI) && (rssi <= OPPO_83_MIDDLE2_RSSI)) {
                    return 2;
                }
                else if ((rssi > OPPO_83_MIDDLE2_RSSI) && (rssi <= OPPO_83_MAX_RSSI)) {
                    return 3;
                }
                else {
                    return 4;
                }  
            } else { //if(Build.MODEL.equals("R815T"))
                if (rssi <= OPPO_39_MIN_RSSI) {
                    return 0;
                }
                else if ((rssi > OPPO_39_MIN_RSSI) && (rssi <= OPPO_39_MIDDLE1_RSSI)) {
                    return 1;
                }
                else if ((rssi > OPPO_39_MIDDLE1_RSSI) && (rssi <= OPPO_39_MIDDLE2_RSSI)) {
                    return 2;
                }
                else if ((rssi > OPPO_39_MIDDLE2_RSSI) && (rssi <= OPPO_39_MAX_RSSI)) {
                    return 3;
                }
                else {
                    return 4;
