...
public class KeyguardHostView extends KeyguardViewBase {
    ...
    private boolean cameraDisabledByDpm() {
    	Log.d(TAG, "cameraDisabledByDpm --> mCameraDisabled = "+mSafeModeEnabled+" --> disabledFeatures = "+((mDisabledFeatures & DevicePolicyManager.KEYGUARD_DISABLE_SECURE_CAMERA) != 0));
    ...
    private void addDefaultWidgets() {
        ...
        Log.d(TAG, "addDefaultWidgets --> mSafeModeEnabled = "+mSafeModeEnabled+" --> cameraDisabledByDpm = "+cameraDisabledByDpm());
        if (!mSafeModeEnabled && !cameraDisabledByDpm()
            ...
            Log.d(TAG, "addDefaultWidgets -->cameraWidget = "+cameraWidget);
