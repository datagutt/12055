        ...
        if (mPanelChordingKey != 0) {
            ...
            if (featureId == FEATURE_OPTIONS_PANEL && mActionBar != null &&
                ...
                if (st.isOpen || st.isHandled) {
                    ...
                    //#ifndef VENDOR_EDIT
                    //Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/09, Modify for 
                    /*
    ...
    /*private*/ final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            ...
            if (!isDestroyed()) {
                ...
                if (handled) {
            //#ifdef VENDOR_EDIT
            //Jiangtao.Guo@Prd.SysSrv.Charge, 2012/07/09, Add for log
                Log.w(TAG,"user consume KeyCode = " + keyCode 
                        + " Action = " + action
            ...
            //Jiangtao.Guo@Prd.SysSrv.Charge, 2012/07/09, Add for log
                    ...
                    Log.w(TAG,"PhoneWindow consume KeyCode = " + keyCode 
                        + " Action = " + action
                        + " featureId = " + mFeatureId);
                }
            //#endif /* VENDOR_EDIT */
...
//Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/29, Add for statusBar
        private boolean bTraceStatusBar = false;
//#endif /* VENDOR_EDIT */
...
//Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/28, Add for statusBar
            if(ev.getAction() != MotionEvent.ACTION_MOVE){
                if(ev.getAction() == MotionEvent.ACTION_DOWN && ev.getRawY() < 30 && ((getAttributes().flags & FLAG_FULLSCREEN) != 0)){
                    Log.w(TAG,"PhoneWindow begain trace ");
                    bTraceStatusBar = true;
                }else if(ev.getAction() == MotionEvent.ACTION_UP && bTraceStatusBar && ev.getRawY() > 150){
                    Log.w(TAG,"PhoneWindow end trace ");
                    bTraceStatusBar = false;
                    try{
                        //WindowManagerHolder.sWindowManager.showStatusBar();
                        new IOppoWindowManagerImpl().showStatusBar();
...
//#endif /* VENDOR_EDIT */
            ...
            if (mode != null) {
                ...
                if (mActionModeView == null) {
                    if (isFloating()) {
                        //#ifndef VENDOR_EDIT
                        //#@OppoHook
                        //Jianhui.Yu@Plf.Framework.SDK, 2013-09-04 : Modify for ActionBar of oppo style
                        /*
                        mActionModeView = new ActionBarContextView(mContext);
                        */
                        //#else  /* VENDOR_EDIT */
                        mActionModeView = OppoPhoneWindow.newActionBarContextView(mContext);
                        //#endif /* VENDOR_EDIT */
                        ...
                        if (stub != null) {
                            //#ifdef VENDOR_EDIT
                            //#@OppoHook
                            //Jianhui.Yu@Plf.Framework.SDK, 2013-09-04 : Add for ActionBar of oppo style
                            OppoPhoneWindow.setActionModeLayout(stub);
                            //#endif /* VENDOR_EDIT */
                ...
                if (mActionModeView != null) {
                    ...
                    //#ifndef VENDOR_EDIT
                    //#@OppoHook
                    //Jianhui.Yu@Plf.Framework.SDK, 2013-09-05 : Modify for ActionBar of oppo style
                    /*
                    mode = new StandaloneActionMode(getContext(), mActionModeView, wrappedCallback,
                            mActionModePopup == null);
                    */
                    //#else  /* VENDOR_EDIT */
                    mode = OppoPhoneWindow.newActionMode(getContext(), mActionModeView, wrappedCallback,
                            mActionModePopup == null);
                    //#endif /* VENDOR_EDIT */
                    if (callback.onCreateActionMode(mode, mode.getMenu())) {
                        ...
                        */
                        //#else  /* VENDOR_EDIT */
                        mActionModeView.animateToVisibility(View.VISIBLE);
                        //#endif /* VENDOR_EDIT */
                        mActionMode = mode;
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        //#ifdef VENDOR_EDIT
        //#@OppoHook
        //Jianhui.Yu@Plf.Framework.SDK, 2013-09-04 : Add for ActionBar of oppo_style
        layoutResource = hookGetScreenLayout(layoutResource);
        //#endif /* VENDOR_EDIT */
    ...
    public int hookGetScreenLayout(int layoutResource) {
