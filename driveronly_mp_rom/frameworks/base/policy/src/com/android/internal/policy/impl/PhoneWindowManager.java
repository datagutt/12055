...
import com.android.internal.policy.impl.keyguard.OppoKeyguardViewMediator;
...
import static android.view.WindowManager.LayoutParams.TYPE_APK_LOCKSCREEN;
//#endif /* VENDOR_EDIT */
//#ifdef VENDOR_EDIT
//Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/09, Add for WheelShot
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    OppoKeyguardViewMediator mKeyguardMediator;
	//#endif /* VENDOR_EDIT */
	
    //#ifndef VENDOR_EDIT
    //@OppoHook
    //yaolang@Plt.Framework Modify for Oppo global actions
    ...
    @android.annotation.OppoHook(level = android.annotation.OppoHook.OppoHookType.CHANGE_CODE, 
                                 ...
                                 note = "wangzequan@EXP.sysFramework,modify for EXP and Prd home behavior")
...
//Boning.Li@Prd.PlatSrv.Poweronoff 2013/03/13 add for Poweronoff     					
	public static final String OPPO_ACTION_SHUTDOWN = "android.oppo.ACTION_SHUTDOWN";
    public static final String MASTER_SHUTDOWN = "android.intent.action.MASTER_CLEAR";
	public static final String RESTORE_SHUTDOWN = "android.intent.action.RESTORE_DEFAULT_SETTINGS";
//#endif /* VENDOR_EDIT */	
    ...
    /*private*/ void interceptPowerKeyDown(boolean handled) {
	    ...
	    //#ifndef VENDOR_EDIT
		//#@OppoHook
		//Jun.Zhang@Plf.Framework.Input, 2012/12/25, Modify for power key longpress delay 1s, port from Jiangtao.Guo@Prd.SysSrv.Charge
	    /*
	            mHandler.postDelayed(mPowerLongPress, ViewConfiguration.getGlobalActionKeyTimeout());
	    */
	    //#else /* VENDOR_EDIT */
	            mHandler.postDelayed(mPowerLongPress, ViewConfiguration.getGlobalActionKeyTimeout() + 500);
	    //#endif /* VENDOR_EDIT */
        }
    }
...
//#ifndef VENDOR_EDIT
//#@OppoHook
//Jun.Zhang@Plf.Framework.Input, 2012/12/25, Modify for screenCapture port from Jiangtao.Guo@Prd.SysSrv.Charge
/*
...
//#endif /* VENDOR_EDIT */
    ...
    void showGlobalActionsDialog() {
        if (mGlobalActions == null) {
            ...
            //#else /* VENDOR_EDIT */
            mGlobalActions = new OppoGlobalActions(mContext, mWindowManagerFuncs);
        	//#endif /* VENDOR_EDIT */
        }
 ...
 @android.annotation.OppoHook(level = android.annotation.OppoHook.OppoHookType.CHANGE_ACCESS, 
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        if (!mHeadless) {
            ...
            mKeyguardMediator = new OppoKeyguardViewMediator(context, null);
        }
...
//Boning.Li@Prd.PlatSrv.Poweronoff 2013/03/13 add for Poweronoff
		keyDispatchFilter.addAction(OPPO_ACTION_SHUTDOWN);
        keyDispatchFilter.addAction(MASTER_SHUTDOWN);
		keyDispatchFilter.addAction(RESTORE_SHUTDOWN);
//#endif /* VENDOR_EDIT */
	...
	//#ifdef VENDOR_EDIT
    //Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/28, Add for statusBar
	@android.annotation.OppoHook(level = android.annotation.OppoHook.OppoHookType.NEW_FIELD,
			property = android.annotation.OppoHook.OppoRomType.ROM,
			note = "hejiamiao add for pull down status bar when full screen")
    boolean bForceShowStatusBar = false;
	...
	@android.annotation.OppoHook(level = android.annotation.OppoHook.OppoHookType.NEW_METHOD,
			property = android.annotation.OppoHook.OppoRomType.ROM,
			note = "hejiamiao add for pull down status bar when full screen")
	//type 0:remove from windowmanager.
	//type 1:remove from touch other place.
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (attrs != null) {
                ...
                if (type == WindowManager.LayoutParams.TYPE_KEYGUARD
					...
					//#ifndef VENDOR_EDIT
                    //HuangYuan@Prd.DesktopApp.Keyguard, 2013/04/01, Add for [apk lockscreen], {
                        || type == WindowManager.LayoutParams.TYPE_APK_LOCKSCREEN) {
                    //} add end for [apk lockscreen].  
					//#endif /* VENDOR_EDIT */                      
            ...
            if (down) {
                ...
                //#ifdef VENDOR_EDIT
                //Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/15, Add for 
                    else {
                        Slog.e(TAG, "send oppo.intent.action.lockmusiccontrol");
                        mContext.sendBroadcast(new Intent("oppo.intent.action.lockmusiccontrol"));
                    }
                //#endif /* VENDOR_EDIT */
    ...
    public void applyPostLayoutPolicyLw(WindowState win,
        ...
        if (mTopFullscreenOpaqueWindowState == null &&
            ...
            //#ifndef VENDOR_EDIT
            //HuangYuan@Prd.DesktopApp.Keyguard, 2013/04/03, Modify for  [apk lockscreen], {
            /*
                if (attrs.type == TYPE_KEYGUARD) {
            */
            //===== Below is newer: =====
                if (attrs.type == TYPE_KEYGUARD || attrs.type == TYPE_APK_LOCKSCREEN) {
            //#else /* VENDOR_EDIT */
    ...
    /** {@inheritDoc} */
	@android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.CHANGE_CODE,
		                      note="Jiangtao.Guo add for InputManager")
    @Override
    public int finishPostLayoutPolicyLw() {
        ...
        if (mStatusBar != null) {
            ...
            /// @}
                ...
                // case though.
            //#ifndef VENDOR_EDIT
            //Jiangtao.Guo@Prd.SysSrv.InputManager, 2013/03/28, Modify for 
            /*
                if (topIsFullscreen) {
            */
            //#else /* VENDOR_EDIT */
                if (topIsFullscreen && !bForceShowStatusBar) {
            //#endif /* VENDOR_EDIT */
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags, boolean isScreenOn) {
        ...
        if ((isScreenOn && !mHeadless) || (isInjected && !isWakeKey)) {
            ...
            if (down && isWakeKey && isWakeKeyWhenScreenOff(keyCode)) {
                ...
                if (!mPowerManager.bIsScreenOffBecauseOfProximityPositive()) {
                //#endif /* VENDOR_EDIT */
    ...
    BroadcastReceiver mKeyDispatchReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            synchronized (mKeyDispatchLock) {
// Boning.Li@Prd.PlatSrv.Poweronoff 2013/03/13 add for Poweronoff       					
            	 if (action.equals(OPPO_ACTION_SHUTDOWN)) {
            		if (DEBUG_INPUT) {
                        Log.v(TAG, "Receive oppo ACTION_SHUTDOWN");
                    }
					if (SystemProperties.getBoolean("ro.monkey", false)) {
           				 Log.d(TAG, "Cannot disable keydispatch when Monkey is running.");
                    } else {
                    	mKeyDispatcMode = KEY_DISPATCH_MODE_ALL_DISABLE;
                    }
		 			
				 } else if (action.equals(MASTER_SHUTDOWN) || action.equals(RESTORE_SHUTDOWN)){
						if (DEBUG_INPUT) {
							Log.v(TAG, "Receive MASTER_SHUTDOWN");
                    } 
						mKeyDispatcMode = KEY_DISPATCH_MODE_ALL_DISABLE;
				}
//#endif /* VENDOR_EDIT */					
    ...
    public boolean performHapticFeedbackLw(WindowState win, int effectId, boolean always) {
		...
		//#ifdef VENDOR_EDIT
		//Jiangtao.Guo@Prd.SysSrv.Charge, 2012/07/17, Add for  do not feedback when screen turn off.
	...
	public void keyguardSetApkLockScreenShowing(boolean showing) {
		if (mKeyguardMediator != null) {
			mKeyguardMediator.keyguardSetApkLockScreenShowing(showing);
		}
		else{
			Log.d(TAG, "mKeyguardMediator == NULL!!!!");
		}
	}
	//#endif /* VENDOR_EDIT */
	//#ifdef VENDOR_EDIT
	...
	public void keyguardShowSecureApkLock(boolean show) {
		if (mKeyguardMediator != null) {
			mKeyguardMediator.keyguardShowSecureApkLock(show);
		} else {
			Log.d(TAG, "keyguardShowSecureApkLock mKeyguardMediator == NULL!!!!");
		}
	}      
	//#endif /* VENDOR_EDIT */
}
