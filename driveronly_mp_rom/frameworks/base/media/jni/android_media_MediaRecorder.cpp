...
#ifdef VENDOR_EDIT 
//liyajun@MediaSrv.Group.module, 2012/09/21, Add for MediaRecoder "getduration"
static int
android_media_MediaRecorder_getduration(JNIEnv *env, jobject thiz)
{
    ALOGV("getduration");
    sp<MediaRecorder> mr = getMediaRecorder(env, thiz);
    int msec = 1000;
    process_media_recorder_call(env, mr->getduration(&msec), "java/lang/RuntimeException", "getduration failed.");
...
static JNINativeMethod gMethods[] = {
    ...
    #ifdef VENDOR_EDIT 
    //liyajun@MediaSrv.Group.module, 2012/09/21, Add for MediaRecoder "getduration"
    {"getduration",         "()I",                              (void *)android_media_MediaRecorder_getduration},
    #endif /* VENDOR_EDIT */
};
