...
//#ifdef VENDOR_EDIT
//Xianfen.Fu@Prd.Video.VideoCodec,2012/06/05,Add for camcordprofile
    public List<String> getSupportedVideoQuality(int cameraId) { 	
        String str = native_get_camcorder_profile_caps(cameraId);
...
//#ifdef VENDOR_EDIT
//Xianfen.Fu@Prd.Video.VideoCodec,2012/06/05,Add for camcordprofile
    private static native final String native_get_camcorder_profile_caps(int cameraId);
//#endif /*VENDOR_EDIT*/
