...
//#ifdef VENDOR_EDIT
//Hairong.Zou@ComUI.View, 2012/07/23, Add for 
import com.oppo.view.OppoVolumePanel;  
//#endif /* VENDOR_EDIT */
...
public class AudioService extends IAudioService.Stub implements OnFinished {
    ...
    /** The UI */
    //#ifndef VENDOR_EDIT
    //Hairong.Zou@ComUI.View, 2012/07/23, Modify for 
    /*
    private VolumePanel mVolumePanel;
    */
    //#else /* VENDOR_EDIT */
    private OppoVolumePanel mVolumePanel;
    //#endif /* VENDOR_EDIT */ 
	...
	//#ifdef VENDOR_EDIT 
	//liyajun@MediaSrv.Group.module, 2013/06/19,Add for
    ...
    private static final String[] SOUND_EFFECT_FILES = new String[] {
        ...
        "KeypressReturn.ogg",
        //#ifdef VENDOR_EDIT
        //liyang@Pdt.Audio.RingtoneMgr, 2012/05/21, Add for system ringtone
        "camera_click.ogg",      //for camera Normal mode
		"lomo_click.mp3",        //for camera Lomo mode
		"VideoRecord.ogg",       //for camera Video mode 
		"sound_5s.mp3",          //for 5s Timing taking pictures
		"sound_10s.mp3",         //for 10s Timing taking pictures
		"lowbattery.ogg",        //for Low Battery
		"warnings.ogg",          //for warrning.ogg
		"delete.mp3",            //for delete file
		"error.ogg",             //for error
		"Lock.ogg",              //for Lock the screen
		"Unlock.ogg",            //for Unlock the screen
		"extended_effect_a.ogg", //for leafing effect
        "extended_effect_b.ogg", //for clock effect
        "extended_effect_c.ogg", //for clip effect
        "extended_effect_d.ogg", //for extended d effect
        "extended_effect_e.ogg", //for extended e effect
        "charge.ogg",            //for usb in_out
        "VideoRec_Start.ogg",    //for REC Video Start
        "VideoRec_End.ogg",      //for REC Video End
        "camera_continuous.ogg", //for camera continuous
        "camera_focus.ogg",      //for The camera is focused   
        "rec_start.ogg",         //for rec Start
        "rec_end.ogg",           //for rec End
        "mes_send.ogg",          //for mes send   
        "mes_receive.ogg"        //for mes receive   
		//#endif /* VENDOR_EDIT */
    };
    ...
    private final int[][] SOUND_EFFECT_FILES_MAP = new int[][] {
        ...
        {4, -1},  // FX_FOCUS_RETURN
        //#ifdef VENDOR_EDIT
        //liyang@Pdt.Audio.RingtoneMgr, 2012/05/24, Add for system ringtone
        {5, -1},  //for camera Normal mode
		{6, -1},  //for camera Lomo mod
		{7, -1},  //for camera Video mode
		{8, -1},  //for 5s Timing taking pictures
		{9, -1},  //for 10s Timing taking pictures
		{10, -1},   //for Low Battery
		{11, -1},   //for warrning.mp3
		{12, -1},   //for delete file
		{13, -1},   //for error
		{14, -1},   //for Lock the screen
		{15, -1},   //for Unlock the screen
		{16, -1},   //for leafing effect
		{17, -1},   //for clock effect
		{18, -1},   //for clip effect
		{19, -1},   //for extended d effect
		{20, -1},   //for extended e effect
		{21, -1},   //for usb 
		{22, -1},   //for REC Video Start
		{23, -1},   //for REC Video End
		{24, -1},   //for camera continuous
		{25, -1},   //for The camera is focused
		{26, -1},   //for rec Start
		{27, -1},   //for rec End
		{28, -1},   //for mes send
		{29, -1}    //for mes receive
		//#endif /* VENDOR_EDIT */
    };
   ...
   //#ifndef VENDOR_EDIT
    //GuoLing@Prd.AudioRouting, 2013/03/12, Modify for max stream volume of oppo.
    /*
    private final int[] MAX_STREAM_VOLUME = new int[] {
        6,  // STREAM_VOICE_CALL
        7,  // STREAM_SYSTEM
        7,  // STREAM_RING
        13, // STREAM_MUSIC    //change from 13 to 16 according our smart phone standard
        7,  // STREAM_ALARM
    ...
    */
    ...
    private final int[] MAX_STREAM_VOLUME = new int[] {
        ...
        7,  // STREAM_SYSTEM
        7,  // STREAM_RING
        16, // STREAM_MUSIC    //change from 13 to 16 according our smart phone standard
        7,  // STREAM_ALARM
        7,  // STREAM_NOTIFICATION
        15, // STREAM_BLUETOOTH_SCO
        7,  // STREAM_SYSTEM_ENFORCED
     ...
     *  STREAM_VOLUME_ALIAS_NON_VOICE for a non voice capable device (tablet).*/
     /// M: Add FM & MATV
    //#ifndef VENDOR_EDIT
    //Xianfeng.Fu@Prd.AudioRouting, 2013/04/03, Modify for
    /*
...
*/
//#else /* VENDOR_EDIT */
        mVolumePanel = new OppoVolumePanel(context, this);
//#endif /* VENDOR_EDIT */
    ...
    private void sendVolumeUpdate(int streamType, int oldIndex, int index, int flags) {
		...
		//#ifndef VENDOR_EDIT
        //WangHu@Prd.Audio.MediaProvider, 2012/08/06, Remove for we don't need this strategy of MTK.
        /* 
    ...
    public void setRingerMode(int ringerMode) {
        ...
        if (ringerMode != getRingerMode()) {
            ...
            //WangHu@Prd.Audio.MediaProvider, 2012/08/06, Remove for we don't need this strategy of MTK.
            /*                
            // add by jackie for Notify RingerMode changed to AudioProfile
    ...
    private void onConfigureSafeVolume(boolean force) {
        synchronized (mSafeMediaVolumeState) {
            ...
            if ((mMcc != mcc) || ((mMcc == 0) && force)) {
                ...
                //#ifndef VENDOR_EDIT
                //GuoLing@Prd.AudioRouting, 2013/03/13, Modify for disable safe media volume
                /*
    ...
    private boolean checkForRingerModeChange(int oldIndex, int direction,  int step) {
        ...
        case RINGER_MODE_VIBRATE:
            ...
            if ((direction == AudioManager.ADJUST_LOWER)) {
                ...
                //#ifndef VENDOR_EDIT
                //WangHu@Prd.Audio.MediaProvider, 2012/08/22, Remove for 
                /*
    ...
    private class AudioHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                //liyajun@MediaSrv.Group.module, 2013/06/19,Add for
				case MSG_FADEUP:
					 mCurrentFadeVolume += 1;
					 if (mCurrentFadeVolume <= mSaveActiveStreamVolume) {
						   setStreamVolume(mSaveActiveStreamType, mCurrentFadeVolume, 0);
						   mAudioHandler.sendEmptyMessageDelayed(MSG_FADEUP, 200);					   
					 } else {
						   mCurrentFadeVolume = 1;
					 }
					 Log.e(TAG, "MSG_FADEUP " + mCurrentFadeVolume);
					 break;
               //#endif /* VENDOR_EDIT */
                ...
                case MSG_MEDIA_SERVER_STARTED:
	                ...
	                //#ifdef VENDOR_EDIT 
                    //liangchagnwei@MediaSrv.Group.module, 2013/06/19,Add for dolby
                    /* DOLBY_DAP */
        ...
        synchronized (mConnectedDevices) {
            ...
            if (isConnected && !connected) {
	         ...
	         Log.d(TAG,"handleDeviceConnection remove:" + "connected:" + connected + ",device:" + device);
	            ...
	            //#ifdef VENDOR_EDIT 
                //liyajun@MediaSrv.Group.module, 2013/06/19,Add for
                mSaveActiveStreamType = getActiveStreamType(-1);
                if (mSaveActiveStreamType == AudioSystem.STREAM_MUSIC) {					
                    AudioSystem.setStreamVolumeIndex(mSaveActiveStreamType, 0, device);
                }
				//#endif /* VENDOR_EDIT */
                 AudioSystem.setDeviceConnectionState(device,
                                                      AudioSystem.DEVICE_STATE_AVAILABLE,
	...
	//#ifdef VENDOR_EDIT 
    //liyajun@MediaSrv.Group.module, 2013/06/19,Add for
	private int mSaveActiveStreamVolume = -1;
	private int mSaveActiveStreamType = -1;
	private void restoreStreamVolume() {
	 	mSaveActiveStreamType = -1;
	 	mSaveActiveStreamVolume = -1;
    }

    private void decreaseStreamVolume() {
    	
        if (mSaveActiveStreamType == AudioSystem.STREAM_MUSIC) {
			mSaveActiveStreamVolume = getStreamVolume(mSaveActiveStreamType);
			if (mSaveActiveStreamVolume > MAX_STREAM_VOLUME[mSaveActiveStreamType]*3/4) {
				mSaveActiveStreamVolume = MAX_STREAM_VOLUME[mSaveActiveStreamType]*3/4;
			}
            setStreamVolume(mSaveActiveStreamType, 1, 0);
            sendMsg(mAudioHandler, MSG_FADEUP, SENDMSG_QUEUE,
                    0, 0, null, 50);
        }       
    }
	//#endif /* VENDOR_EDIT */
    ...
    private void onSetWiredDeviceConnectionState(int device, int state, String name)
    {
	    ...
	    Log.d(TAG,"onSetWiredDeviceConnectionState:" + "device:" + device + ",state:" + state);
            ...
            if (state != 0) {
                ...
                //#ifdef VENDOR_EDIT 
                //GuoLing@Prd.AudioRouting, 2013/09/17, move here to consider BT connected
        ...
        synchronized(mRingingLock) {
            synchronized(mRCStack) {
                if ((mMediaReceiverForCalls != null) &&
                    ...
                    //#ifdef VENDOR_EDIT
                    //ChengJun.Duan@Prd.CommApp.Phone, 2013/03/06, 
                    //when ringing or offhook,the event should be dealt by phone
                                        || getMode() == AudioSystem.MODE_IN_CALL_2
...
//        if(true) {
  ...
  public boolean isFmOn() {
	...
	public int[] getActiveAudioPids() {
		return AudioSystem.getActiveAudioPids();
	}
}
