...
//#ifdef VENDOR_EDIT
//WangHu@Prd.Audio, 2013/08/30, Add for 
...
public class AudioManager {
	...
	*@hide The audio stream for MATV */
     ...
     */
    //#ifndef VENDOR_EDIT
    //GuoLing@Prd.AudioRouting, 2013/03/12, Modify for default stream volume of oppo.
    /*
    ...
    */
     ...
     */
    //#ifndef VENDOR_EDIT
    //liyang@Pdt.Audio.RingtoneMgr, 2012/05/21, Modify for 
    /*
    public static final int NUM_SOUND_EFFECTS = 9;
    */
    //#else /* VENDOR_EDIT */
    public static final int CAMERA_CLICK_NORMAL = 9;        //for camera Normal mode    
    public static final int CAMERA_CLICK_LOMO = 10;         //for camera Lomo mode
    public static final int CAMERA_CLICK_VIDEO = 11;        //for Video Camera mode
    public static final int CAMERA_CLICK_5S = 12;           //for 5s Timing taking pictures
    public static final int CAMERA_CLICK_10S = 13;          //for 10s Timing taking pictures
    public static final int SYSTEM_LOW_BATTERY = 14;        //for Low Battery
    public static final int SYSTEM_RINGTONE_WARRNING = 15;  //for warrning.mp3
    public static final int SYSTEM_RINGTONE_DELETE = 16;    //for delete file    
    public static final int SYSTEM_RINGTONE_ERROR = 17;     //for error
    public static final int SYSTEM_RINGTONE_LOCK =18;       //for Lock the screen
    public static final int SYSTEM_RINGTONE_UNLOCK = 19;    //for Unlock the screen
    public static final int FX_EXTENDED_EFFECT_A = 20; 		//add or leafing effect
	public static final int FX_EXTENDED_EFFECT_B = 21;   	//add for clock effect
	public static final int FX_EXTENDED_EFFECT_C = 22;  	//add for clip effect
	public static final int FX_EXTENDED_EFFECT_D = 23; 		//add for d effect
	public static final int FX_EXTENDED_EFFECT_E = 24;		//add for e effect
	public static final int SYSTEM_USB_INSERTED = 25;       //add for usb
	public static final int VIDEO_CAMERA_START = 26;        //for REC Video Start
	public static final int VIDEO_CAMERA_END = 27;          //for REC Video End
    public static final int CAMERA_CONTINUOUS = 28;         //for camera continuous
    public static final int CAMERA_FOCUS = 29;              //for The camera is focused
    public static final int RECORDER_START = 30;            //for rec start
    public static final int RECORDER_END = 31;              //for rec end 
    public static final int MESSAGE_SEND = 32;              //for mes send
    public static final int MESSAGE_RECEIVE = 33;           //for mes receive    
    public static final int NUM_SOUND_EFFECTS = 34;         //Total Number of sounds
    //#endif /* VENDOR_EDIT */
    /**
    ...
    private boolean querySoundEffectsEnabled() {
        //#ifndef VENDOR_EDIT
        //liyang@Pdt.Audio.RingtoneMgr, 2012/01/06, Modify for decide whether we should play effect or not
        /*
            return Settings.System.getInt(mContext.getContentResolver(), Settings.System.SOUND_EFFECTS_ENABLED, 1) != 0;
        */
        //#else /* VENDOR_EDIT */
    ...
    //#ifdef VENDOR_EDIT
    //WangHu@Prd.Audio, 2013/08/30, Add for 
    private static final void initDefaultStreamVolume() {
        String productName = SystemProperties.get("ro.product.name", "oppo");
        if(productName.equals("OPPO89T_13009")){
