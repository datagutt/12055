...
public class RingtoneManager {
    ...
    //#ifdef VENDOR_EDIT
    //chentiequn@Plf.MediaApp.RingtoneMgr, 2011/12/15, Add for ringer and notifications of the second sim card
	@OppoHook(level=OppoHookType.NEW_FIELD,
		     property=OppoRomType.OPPO, note="ringtone of the second sim card")	
    public static final int TYPE_RINGTONE_SIM2 = 16;
	
	@OppoHook(level=OppoHookType.NEW_FIELD,
		     property=OppoRomType.OPPO, note="notifications of the second sim card")	
    public static final int TYPE_NOTIFICATION_SIM2 = 32;
    //#endif /* VENDOR_EDIT */
	...
	//ifdef VENDOR_EDIT
	//chentiequn@Plf.MediaApp.RingtoneMgr add to save SIMCARD2'S ringtone URI
	@OppoHook(level=OppoHookType.NEW_FIELD,
		     property=android.annotation.OppoHook.OppoRomType.OPPO, note="to save SIMCARD2'S ringtone URI")	
	public static final String EXTRA_RINGTONE_EXISTING_URI_SIM2 =
            "android.intent.extra.ringtone.EXISTING_URI_SIM2";
    //endif VENDOR_EDIT
    /**
     * Given to the ringtone picker as a {@link Uri}. The {@link Uri} of the
    ...
    //#ifndef VENDOR_EDIT
    //WangHu@Prd.Audio.MediaProvider, 2013/09/09, Modify for remove MTK code.
    /*
    ...
    */
	...
	@OppoHook(level=OppoHookType.CHANGE_CODE,
		     property=OppoRomType.OPPO, note="Add for NOTIFICATION_SIM2")		
    public int inferStreamType() {
        switch (mType) {
            ...
            //#ifdef VENDOR_EDIT
            //chentiequn@Plf.MediaApp.RingtoneMgr, 2012/12/18, Add for NOTIFICATION_SIM2
			//#@OppoHook
    ...
    private void setFilterColumnsList(int type) {
        ...
        //#ifdef VENDOR_EDIT
        //liyang@Pdt.Audio.RingtoneMgr, 2012/05/17, Modify for set for SIM2 
        /*
        if ((type & TYPE_RINGTONE) != 0 || (type & TYPE_VIDEO_CALL) != 0 ) {
        ...
        */
        ...
        if ((type & TYPE_NOTIFICATION) != 0 || (type & TYPE_NOTIFICATION_SIM2) != 0) {
            columns.add(MediaStore.Audio.AudioColumns.IS_NOTIFICATION);
        }     
        //#endif /* VENDOR_EDIT */
    ...
    //#ifdef VENDOR_EDIT
    //chentiequn@Plf.MediaApp.RingtoneMgr, 2012/12/18, Add for ringer to get the right ringtone uri;
	@OppoHook(level=OppoHook.OppoHookType.NEW_METHOD,
		     property=OppoRomType.OPPO, note="for ringer to get the right ringtone uri")	
    public static Ringtone getRingtone(final Context context, long SlotID, Uri ringtoneUri) {
        Ringtone ringtone = getRingtone(context, ringtoneUri, -1);
        if (null == ringtone) {
            if (0 == SlotID) {
                ringtone = getRingtone(context, Settings.System.DEFAULT_RINGTONE_URI, -1);
                Log.w(TAG, "getRingtone_sim1: the given SlotID is 0,Use default ringtone");
            } else if (1 == SlotID) {
                ringtone = getRingtone(context, Settings.System.DEFAULT_RINGTONE_SIM2_URI, -1);
                Log.w(TAG, "getRingtone_sim2: the given SlotID is 1,Use default ringtone_sim2");
            } else {
                ringtone = null;
            }   
        }
	...
	//#ifdef VENDOR_EDIT
    //chentiequn@Pdt.Audio.RingtoneMgr, 2012/06/07, Add for get rintone for specific type
	@OppoHook(level=OppoHookType.NEW_METHOD,
		     property=OppoRomType.OPPO, note=" get rintone for specific type")
    public static Ringtone getRingtoneForType(final Context context, Uri ringtoneUri,int streamType) {
        return getRingtone(context, ringtoneUri, streamType);
    }        
    //#endif /* VENDOR_EDIT */
    ...
    @OppoHook(level=OppoHookType.CHANGE_CODE,
		     property=OppoRomType.OPPO, note="the second sim card setting")		
    private static String getSettingForType(int type) {
        ...
        //#ifdef VENDOR_EDIT
        //chentiequn@Plf.MediaApp.RingtoneMgr, 2012/12/18, Add for the second sim card setting
		//#@OppoHook
        else if ((type & TYPE_RINGTONE_SIM2) != 0) {
            return Settings.System.RINGTONE_SIM2;
        } else if ((type & TYPE_NOTIFICATION_SIM2) != 0) {
            return Settings.System.NOTIFICATION_SOUND_SIM2;
        }    
        //#endif /* VENDOR_EDIT */
        else {
            return null;
     ...
     */
    @OppoHook(level=OppoHookType.CHANGE_CODE,
		     property=OppoRomType.OPPO, note="get default type for the second sim card")	
    public static int getDefaultType(Uri defaultRingtoneUri) {
        ...
        //#ifdef VENDOR_EDIT
		//#@OppoHook
        //chentiequn@Plf.MediaApp.RingtoneMgr, 2012/12/18, Add for get default type for the second sim card
        else if (defaultRingtoneUri.equals(Settings.System.DEFAULT_RINGTONE_SIM2_URI)) {
            return TYPE_RINGTONE_SIM2;
        } else if (defaultRingtoneUri.equals(Settings.System.DEFAULT_NOTIFICATION_SIM2_URI)) {
            return TYPE_NOTIFICATION_SIM2;
        }        
        //#endif /* VENDOR_EDIT */
        else {
            return -1;
     ...
     */
     @OppoHook(level=OppoHookType.CHANGE_CODE,
		     property=OppoRomType.OPPO, note=" set Ringtones for SIM2")
    public static Uri getDefaultUri(int type) {
		...
		//#ifdef VENDOR_EDIT
		//#@OppoHook
        //chentiequn@Plf.MediaApp.RingtoneMgr, 2012/10/07, Add for set Ringtones for SIM2
        else if((type & TYPE_RINGTONE_SIM2) != 0) {
            return Settings.System.DEFAULT_RINGTONE_SIM2_URI;
        } else if ((type & TYPE_NOTIFICATION_SIM2) != 0) {
            return Settings.System.DEFAULT_NOTIFICATION_SIM2_URI;
        }
        //#endif /* VENDOR_EDIT */
        else {
            return null;
