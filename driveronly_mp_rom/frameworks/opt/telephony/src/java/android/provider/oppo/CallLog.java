    ...
    public static class Calls implements BaseColumns {
       ...
       // public static final String PHONENO_AREA = "phoneno_area";
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
            ...
            isMtkSupport = context.getPackageManager().hasSystemFeature("mtk.gemini.support");          // MTK or qcom
            isMtkGeminiSupport = context.getPackageManager().hasSystemFeature("oppo.hw.manufacturer.mtk");   //MTK gemini or not			                  
         ...
         */
        public static Uri addCall(CallerInfo ci, Context context, String number,
                int presentation, int callType, long start, int duration, int simId, int vtCall, int ringTime ) {
            ...
            if (vtCall >= 0) {
                ...
                values.put(RING_TIME, ringTime); 
                Log.d("CallLog", "values = " + values);
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number, String private_name,
                int presentation, int callType, long start, int duration, int simId, int vtCall, int private_type, int ringTime) {
            ...
            values.put(RING_TIME, ringTime);
            Log.d("CallLog", "ringTime values = " + values);	
