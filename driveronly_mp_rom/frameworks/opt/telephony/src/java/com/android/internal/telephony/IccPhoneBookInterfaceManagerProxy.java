...
public class IccPhoneBookInterfaceManagerProxy extends IIccPhoneBook.Stub {
    ...
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 ...
                                 note="get sim phonebook's all space")
    public int oppoGetSimPhonebookAllSpace() {
    	return mIccPhoneBookInterfaceManager.oppoGetSimPhonebookAllSpace();
    }
    
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="get sim phonebook's used space")
    public int oppoGetSimPhonebookUsedSpace() {
    	return mIccPhoneBookInterfaceManager.oppoGetSimPhonebookUsedSpace();
    }

    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="get sim phonebook's name length")
    public int oppoGetSimPhonebookNameLength() {
        return mIccPhoneBookInterfaceManager.oppoGetSimPhonebookNameLength();
    }    

    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="get sim phonebook's number length")
    public int oppoGetSimPhonebookNumberLength() {
        return mIccPhoneBookInterfaceManager.oppoGetSimPhonebookNumberLength();
    }
    ...
    public int oppoGetSimPhonebookEmailLength() {
        return mIccPhoneBookInterfaceManager.oppoGetSimPhonebookEmailLength();
    }
    //#endif /* VENDOR_EDIT */
}
