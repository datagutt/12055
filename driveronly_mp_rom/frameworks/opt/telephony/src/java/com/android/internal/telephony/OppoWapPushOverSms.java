...
//#ifdef VENDOR_EDIT 
//#@OppoHook
/** add for push message ,used in Mms */
//yangyc@Plf.CommSrv.Telephony, 2012/06/11, Modify for	
import android.provider.oppo.Telephony;
import android.provider.oppo.Telephony.Sms.Intents;
//#endif /*VENDOR_EDIT*/
 ...
 * @hide
 */
public class OppoWapPushOverSms {
    ...
    public OppoWapPushOverSms(Phone phone, SMSDispatcher smsDispatcher) {
	...
	//#ifndef VENDOR_EDIT 
    /** Permission send sms and push to blacklist. */
	//yangyc@Prd.CommServer.Telephony, 2012/06/11, Modify for	
		//  Intent intent = new Intent(Intents.WAP_PUSH_RECEIVED_ACTION);
	   	//	intent.setType(mimeType);
    //#else /* VENDOR_EDIT */
		Intent intent = new Intent("android.intent.action.NEW_WAPPUSH_TO_BLACKLIST");
	...
	//#else /* VENDOR_EDIT */
		mSmsDispatcher.dispatchToBlackList(intent, permission);
	//#endif /*VENDOR_EDIT*/
