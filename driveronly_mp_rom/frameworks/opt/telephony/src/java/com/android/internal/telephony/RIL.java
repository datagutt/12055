...
//#ifdef VENDOR_EDIT
//WangZhi@EXP.CommService.Telephony,2013/09/17,Add for [oppo apn setting ]
...
//#ifdef VENDOR_EDIT 
//BaoZhu.Yu@Prd.CommApp.Telephony, 2012/06/11, Add for startup's efficiacy -- see bug 204533 211834
...
*/
        ...
        switch(response) {
            ...
            case RIL_UNSOL_CALL_PROGRESS_INFO:
                ...
                //#ifdef VENDOR_EDIT 
                //BaoZhu.Yu@Prd.CommApp.Telephony, 2012/06/11, Add for 20110712 for test
                if(mEMTIsOn) {
                    mEMCallStatusChangedRegistrant.notifyRegistrant(new AsyncResult(null, null, null));
                    break;
                }
                //#endif /* VENDOR_EDIT */
            ...
            case RIL_UNSOL_PHB_READY_NOTIFICATION:
                ...
                //#ifndef VENDOR_EDIT
                //BaoZhu.Yu@Prd.CommApp.Phone, 2013/03/08, Modify for 
                //mPhbReadyRegistrants.notifyRegistrants();
                //#else /* VENDOR_EDIT */
                mbWaitingForEPhbReadyRegistrants = (mPhbReadyRegistrants.size() == 0);
                if (RILJ_LOGD) riljLog("mbWaitingForEPhbReadyRegistrants="+mbWaitingForEPhbReadyRegistrants);
                if (!mbWaitingForEPhbReadyRegistrants) { 
                    mPhbReadyRegistrants.notifyRegistrants();
                } 
                //#endif /* VENDOR_EDIT */
                }
    ...
    */
    ...
    public String lookupOperatorName(String numeric, boolean desireLongName) {
        ...
        if (mvnoOperName == null && desireLongName) { // MVNO-API     
            ...
            } else if (numeric.equals("25001")) {
                operName = "MTS-RUS";
            } else if (numeric.equals("25002")) {
                operName = "MegaFon";
                //WangZhi@EXP.CommService.Telephony,2013/09/17,Add for [oppo vietnamese apn setting ]
                //oppo WangZhi for th spn:"my"&"True-H" and vn spn:"Gmobile"&"VN Mobile"&"Vietnamobile"
            } else if (numeric.equals("45205")) {
                operName = "Vietnamobile";
            } else if (numeric.equals("52000") || numeric.equals("45207")) {
                String spn = "";
                if (FeatureOption.MTK_GEMINI_SUPPORT) {
                    if (mySimId == 0) {
                        spn = SystemProperties.get(PROPERTY_ICC_OPERATOR_ALPHA, "");
                    } else {
                        spn = SystemProperties.get(PROPERTY_ICC_OPERATOR_ALPHA_2, "");
                    }
                } else {
                    spn = SystemProperties.get(PROPERTY_ICC_OPERATOR_ALPHA, "");
                }
                if (spn.equals("TRUE-H")) {
                    operName = "TRUE-H";
                } else if (spn.equals("my")) {
                    operName = "my";
                } else if(spn.equals("Gmobile")){
                    operName = "Gmobile";
                } else if(spn.equals("Beeline VN")) {
                    operName = "Beeline VN";
                }
            }
            //#endif /* VENDOR_EDIT */
