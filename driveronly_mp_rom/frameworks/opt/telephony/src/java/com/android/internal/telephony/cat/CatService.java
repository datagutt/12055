...
public class CatService extends Handler implements AppInterface {
        ...
        switch (cmdParams.getCommandType()) {
            ...
            case OPEN_CHANNEL:
                ...
                if (mTelephonyManager != null && call_state != TelephonyManager.CALL_STATE_IDLE) {
                    ...
                    cmdMsg.mChannelStatus = new ChannelStatus(mBipMgr.getChannelId(),
        ...
        switch (msg.what) {
            ...
            case MSG_ID_OPEN_CHANNEL_DONE:
                ...
                if (ret == ErrorValue.NO_ERROR) {
                    resp = new OpenChannelResponseData(cmd.mChannelStatus, cmd.mBearerDesc,
                            cmd.mBufferSize);
            ...
            case MSG_ID_GET_CHANNEL_STATUS_DONE:
                ...
                CatLog.d("[BIP]", "SS-handleCmdResponse: MSG_ID_GET_CHANNEL_STATUS_DONE:" + cid
                        + ":" + status + ":" + statusInfo);
                ...
                switch (AppInterface.CommandType.fromInt(cmdDet.typeOfCommand)) {
                    case OPEN_CHANNEL:
                        ...
                        if (mCurrentCmd != null
                            ...
                            // resp = new
                            // OpenChannelResponseData(mCurrentCmd.mChannelStatus,
                            // mCurrentCmd.mBearerDesc,
                            // mCurrentCmd.mBufferSize);
                            resp = new OpenChannelResponseData(null, mCurrentCmd.mBearerDesc,
                                    mCurrentCmd.mBufferSize);
    ...
    private void resetPowerOnSequenceFlag() {
        CatLog.d(this, "call resetPowerOnSequenceFlag");
