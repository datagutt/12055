...
//BaoZhu.Yu@Prd.CommApp.Telephony, 2012/06/11, Add for
    ...
    void oppoRegisterForEmCallStatusChanged(Handler h, int what, Object obj);
    
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add for add for engineer mode test")
    void oppoUnregisterForEmCallStatusChanged(Handler h);
    
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add for add for engineer mode test")
    void oppoSetEMMode(boolean on);
    
    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
                                 property=android.annotation.OppoHook.OppoRomType.ROM,
                                 note="add for add for engineer mode test")
    boolean oppoGetEMMode();
//#endif /* VENDOR_EDIT */
}
