...
public final class MccTable
{
    ...
    public static void setSystemLocale(Context context, String language, String country) {
        ...
        //#ifdef VENDOR_EDIT
        //DeDong.Wei@EXP.CommService.Telephony,2013/09/17,Add for [setup wizard ]
		boolean provisioned = android.provider.Settings.Secure.getInt(context.getContentResolver(), 
                android.provider.Settings.Secure.DEVICE_PROVISIONED, 1) == 0;
        //MTK-START [mtk04070][111117][ALPS00093395]Check sim language
        if(((null == l || 0 == l.length()) && (null == c || 0 == c.length())
            && (null == oldSimLang || 0 == oldSimLang.length())) || provisioned) {
        //#endif /* VENDOR_EDIT */
        //MTK-START [mtk04070][111117][ALPS00093395]Check sim language
            try {
