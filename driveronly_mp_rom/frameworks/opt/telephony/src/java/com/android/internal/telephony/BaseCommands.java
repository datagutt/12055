...
//#ifdef VENDOR_EDIT
//BaoZhu.Yu@Prd.CommApp.Phone, 2013/03/08, Add for 
    protected boolean mbWaitingForEPhbReadyRegistrants = false;
//#endif /* VENDOR_EDIT */
...
*/
    ...
    //#ifdef VENDOR_EDIT
    //BaoZhu.Yu@Prd.CommApp.Phone, 2013/03/08, Add for 
        Log.d(LOG_TAG, "registerForPhbReady() mbWaitingForEPhbReadyRegistrants h=" + mbWaitingForEPhbReadyRegistrants);
        if(mbWaitingForEPhbReadyRegistrants)
        { 
           mbWaitingForEPhbReadyRegistrants = false;
...
//#ifdef VENDOR_EDIT 
//BaoZhu.Yu@Prd.CommApp.Telephony, 2012/06/11, Add for engine test mode */
    protected boolean mEMTIsOn = false;
    protected Registrant mEMCallStatusChangedRegistrant;

    public void oppoSetEMMode(boolean on) {
        mEMTIsOn = on;
    }
    public boolean oppoGetEMMode() {
        return mEMTIsOn;
    }
        
    public void oppoRegisterForEmCallStatusChanged(Handler h, int what, Object obj) {
        mEMCallStatusChangedRegistrant = new Registrant (h, what, obj);
    }
    
    public void oppoUnregisterForEmCallStatusChanged(Handler h) {
        mEMCallStatusChangedRegistrant.clear();
    }  
//#endif /* VENDOR_EDIT */
}
