...
//#ifdef VENDOR_EDIT
//Hong.Liu@Prd.DataApp.Contacts, 2012/12/25, Add for
...
public class UiccController extends Handler {
    ...
    //#ifdef VENDOR_EDIT
    //Hong.Liu@Prd.DataApp.Contacts, 2012/12/25, Add for 
    private String tempImsi = null;    
    private boolean isSIMPlugIn = false;    
    //#endif /* VENDOR_EDIT */
        ...
        synchronized (mLock) {
            switch (msg.what) {
               ...
               case EVENT_VIRTUAL_SIM_OFF:
                    ...
                    //#ifndef VENDOR_EDIT
                    //BaoZhu.Yu@Prd.CommApp.Phone, 2013/03/28, Del for
                ...
                case EVENT_SIM_MISSING: 
                    ...
                    //#ifdef VENDOR_EDIT
                    //BaoZhu.Yu@Prd.CommApp.Phone, 2012/12/06, Add for	
                    if(mUiccCard != null && mUiccCard.getApplicationIndex(0) != null) {
                        tempImsi = mUiccCard.getApplicationIndex(0).getIccRecords().getIMSI();
                    }
                    //notifyIccIdForSimPlugOut();
                    //setNotification(EVENT_SIM_MISSING);
                    //#endif /* VENDOR_EDIT */                    
                        ...
                        if (result == null) {
                            ...
                            switch (result[0]) {
                                case 0:
                                    ...
                                    if(FeatureOption.MTK_SIM_HOT_SWAP_COMMON_SLOT == true) {
                                ...
                                default:
                                    ...
                                    //#ifdef VENDOR_EDIT
                                    //BaoZhu.Yu@Prd.CommApp.Phone, 2012/12/06, Add for
                                    if (DBG) log("EVENT_QUERY_SIM_STATUS_FOR_PLUG_IN, isSIMPlugIn:"+isSIMPlugIn);
                                    if(isSIMPlugIn == true) {
                                        notifyIccIdForSimPlugIn();
                                        isSIMPlugIn = false;
                                    }
    ...
    private void notifyIccIdForSimPlugOut() {
        log("YBZ notifyIccIdForSimPlugOut");
        broadcastIccStateChangedIntent(IccCardConstants.INTENT_VALUE_ICC_ABSENT, OppoTelephonyConstant.INTENT_VALUE_ICC_ABSENT_REASON);
    }

    @android.annotation.OppoHook(level=android.annotation.OppoHook.OppoHookType.NEW_METHOD,
								     property=android.annotation.OppoHook.OppoRomType.OPPO,
								     note="null, only for QCOM paltform")
    private void notifyIccIdForSimPlugIn() {
        log("notifyIccIdForSimPlugIn");
        broadcastIccStateChangedIntent(IccCardConstants.INTENT_VALUE_ICC_NOT_READY, 
            OppoTelephonyConstant.INTENT_VALUE_ICC_NOT_READY_REASON);
    }
