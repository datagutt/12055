...
public final class GsmDataConnectionTracker extends DataConnectionTracker {
    ...
    public GsmDataConnectionTracker(PhoneBase p) {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            Uri geminiUri = (PhoneConstants.GEMINI_SIM_2 == mPhone.getMySimId())? 
    ...
    protected void restartRadio() {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            if (PhoneFactory.isDualTalkMode()) {
                ...
                int sim3G = SystemProperties.getInt("gsm.3gswitch", 1) == 2 ? PhoneConstants.GEMINI_SIM_2 : PhoneConstants.GEMINI_SIM_1;
                if (sim3G == simId) {
    ...
    protected void onVoiceCallStarted() {
	    ...
	    if (mGeminiPhone != null) {
               ...
               if(mGeminiPhone.getDataConnectionStateGemini(peerSimId) == PhoneConstants.DataState.CONNECTED 
                  || mGeminiPhone.getDataConnectionStateGemini(peerSimId) == PhoneConstants.DataState.SUSPENDED){
    ...
    protected void onVoiceCallEnded() {
	    ...
	    if (mGeminiPhone != null) {
               ...
               int peerSimId = getPeerSimId();
               if(mGeminiPhone.getDataConnectionStateGemini(peerSimId) == PhoneConstants.DataState.CONNECTED || mGeminiPhone.getDataConnectionStateGemini(peerSimId) == PhoneConstants.DataState.SUSPENDED){
                  mGeminiPhone.updateSimIndicateStateGemini(peerSimId);
               }
            }
        }
    ...
    private void setPreferredApn(int pos) {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            Uri geminiUri = (PhoneConstants.GEMINI_SIM_2 == mPhone.getMySimId())? PREFERAPN_NO_UPDATE_URI_SIM2 : PREFERAPN_NO_UPDATE_URI_SIM1;
    ...
    private ApnSetting getPreferredApn() {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            queryPreferApnUri = (PhoneConstants.GEMINI_SIM_2 == mPhone.getMySimId())? PREFERAPN_NO_UPDATE_URI_SIM2 : PREFERAPN_NO_UPDATE_URI_SIM1;
        }
                    ...
                    if(FeatureOption.MTK_GEMINI_SUPPORT){
                       if(!mIsCallPrefer) {
                            ...
                            if(mGeminiPhone.isRadioOnGemini(peerSimId)){
                              forceFlag = true;
                              logd("[SCRI]Screen ON: but Gemini with Data Prefer sets forceFlag as true");
                            }
                        }
                    }
    ...
    private int getPeerSimId(){
        return (mGsmPhone.getMySimId() == PhoneConstants.GEMINI_SIM_1 ? PhoneConstants.GEMINI_SIM_2 : PhoneConstants.GEMINI_SIM_1);
    }
