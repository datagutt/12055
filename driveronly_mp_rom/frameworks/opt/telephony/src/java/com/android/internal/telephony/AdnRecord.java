...
public class AdnRecord implements Parcelable {
    ...
    public AdnRecord(int efid, int recordNumber, String alphaTag, String number) {
        //#ifdef VENDOR_EDIT 
        //#@OppoHook
        //OPPOROM@Prd.CommApp.Telephony, 2012/06/11, Add for if alphaTag=null, call isEmpty will result null error.
        if(alphaTag == null) {
            alphaTag = "";
        }
        if(number == null) {
    ...
    public AdnRecord(int efid, int recordNumber, String alphaTag, String number, String anr,
        ...
        //#ifdef VENDOR_EDIT 
        // #@OppoHook
        //BaoZhu.Yu@Prd.CommApp.Telephony, 2012/06/11, Add for if alphaTag=null, call isEmpty will result null error.
        if(alphaTag == null) {
            alphaTag = "";
        }
        if(number == null) {
    ...
    public byte[] buildAdnString(int recordSize) {
        ...
        if (TextUtils.isEmpty(number)) {
            ...
            if (!TextUtils.isEmpty(alphaTag)) {
                //#ifdef VENDOR_EDIT 
                //MingLu.Tu@Exp.DataComm.Contacts, 2013/09/17, Modify for [support Thai using 0x81 to save more character]
                if(GsmAlphabet.enableEncodeTo0x81(alphaTag)){
                    byteTag = GsmAlphabet.encodeTo0x81(alphaTag);
                }else{
