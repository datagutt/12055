...
static const char*  HEADERS[] = { "Android system recovery utility",
                         "",
						"press key volume +/- to choose",
...
static const char* FORCE_ITEMS[] = { "reboot system now",
	                             ...
	                             NULL };
#else
static const char* HEADERS[] = { "安卓系统恢复工具",
							 "",
							"使用音量+/-键来选择",
							 "按Power键确认",
							 "",
	                         NULL };
static const char* ITEMS[] = { "-- 立即重启系统",	                       
	                       "-- 清除数据/恢复出厂设置",
	                       "-- 清除缓存",
						   "-- 手动选择安装包",
	                       NULL };

static const char* FORCE_ITEMS[] = { "-- 立即重启系统",
	                             "-- 手动选择安装包",
	                             NULL };
#endif
