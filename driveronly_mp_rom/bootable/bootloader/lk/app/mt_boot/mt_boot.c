		...
		void *ramdisk, unsigned ramdisk_size)
{
    ...
    *ptr++ = 0x54410001;	
    ...
    #ifdef VENDOR_EDIT//Nanwei.Deng@BasicDrv.BL, 2013/02/27, Add for LK debug sign 
    ptr = target_atag_battery(ptr);
    #endif /* VENDOR_EDIT */
    
	#ifdef VENDOR_EDIT
		//yongjun.wu@BasicDrv.LCD, 2013/03/14, Add for lcd adapt[LCD_UBOOT_KERNEL]
	ptr = target_lk_lcd_id(ptr);
	#endif/*VENDOR_EDIT*/
	/* END */
    *ptr++ = 0;
    *ptr++ = 0;
	...
	#ifndef VENDOR_EDIT//Nanwei.Deng@BasicDrv.Charger, 2013/03/25, Add for charger Cancel reboot  
	if(kernel_charging_boot() == 1)
	{
