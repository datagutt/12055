...
private:
	...
	/*OPPO 2011-01-10 zhouhy Add begin for retrieve wchar string length*/
	size_t ApeWcslen(const str_utf16* s);
	/*OPPO 2011-01-10 zhouhy Add end*/
...
private:
	...
	/*OPPO 2011-01-10 zhouhy Add begin for compare wchar string*/
	int ApeWcscmp(const str_utf16* s1, const str_utf16* s2);
	/*OPPO 2011-01-10 zhouhy Add end */
