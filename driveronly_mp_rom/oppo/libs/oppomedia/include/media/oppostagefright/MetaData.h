...
enum {
    ...
    kKeyMPEG4VOS		  = 'MP4C',  //add by luodexiang
    kKeyCodecConfigInfo   = 'cinf',  //add by luodexiang
	kKeyIsAACADIF		  = 'adif',  //add by luodexiang
	kKeyHasUnsupportVideo = 'UnSV',  //add by luodexiang
	kKeyHasUnsupportAudio = 'UnAV',  //add by luodexiang
	kKeyDataSourceObserver = 'dsob', //add by luodexiang
    ...
    kKeyBlockAlIGN		  = 'blal',  // int32_t 
    kKeyH264              = 'h264',  // raw data
    kKeyCodecId = 'coid', //int32_t add by OPPO MultimediaGroup gaojing for ffmpeg dacoder optimize 20110331
    kKeyESDSFlag = 'edsf',
    kkeySoftDecoderFlag = 'sfdf',
    kKeyBitspersample  = 'bips',  // int32_t
    kKeyEnableThread  = 'enth',  // int32_t
    kKeyExtradata      = 'extd',
};
...
enum {
    kTypeWMVSimple,
    kTypeWMVAdvance,
    kTypeWMVComplex,  //oppo MultiMediaGroup ggt add wmv complex profile use ff decode
};
