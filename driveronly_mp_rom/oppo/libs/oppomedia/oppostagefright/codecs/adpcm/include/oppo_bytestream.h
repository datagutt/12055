...
** VENDOR_EDIT 
** FileName: oppo_bytestream.h
** Author: luodexiang
** Create Date: 2012-6-19
** Description: The basic operation byte stream  interface.
** Version: 1.0
** ------------------Revision History: ------------------------
...
#ifndef OPPO_CODEC_BYTESTREAM_H
#define OPPO_CODEC_BYTESTREAM_H
