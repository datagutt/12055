...
#include <media/oppostagefright/DecoderCreateWrap.h>
...
class OppoMediaRecorderListener;
...
struct StagefrightRecorder : public MediaRecorderBase {
	...
	virtual status_t setListener(const sp<OppoMediaRecorder>& listener);
	...
	virtual void sendBuffer(void * buffer);
    virtual int notifyRecord(int msg, int* p1, int* p2, void* data);
	virtual void notify(int msg, int ext1, int ext2);
	virtual void setFlagForState(bool isCreate);
private:
	Mutex  mNotifyLock;
	bool mIsCreate;
	Mutex  mLock;
	...
	sp<OppoMediaRecorder> mListener;
	...
	sp<DecoderCreateWrap>  mDecoderCreater;
