...
//music
#define GEQ_MUSIC_FLAT     0
#define GEQ_MUSIC_DEFAULT  1
#define GEQ_ROCK           2            
#define GEQ_JAZZ           3    
#define GEQ_POP            4    
...
#define param_n            13
	...
	const int PRESET[][GEQ_N][param_n]=
	{
        ...
        //slc_enable    input_level  depth     geq_nband    band1       band2       band3       band4       band5       band6       band7       nb_cf       nb_ol
        {
            ...
            {1,		3,		0,		7,		0,		0,		-4,		-4,		-8,		1,		-1,		3,		0},//music default
            ...
            //video
        //slc_enable    input_level depth       geq_nband   band1       band2       band3       band4       band5       band6       band7       nb_cf       nb_ol            
            {1,		0,		0,		7,		6,		-12,	3,		12,		6,		8,		9,		6,		3},//music video        
            ...
            {1,		0,		1,		7,		0,		0,		0,		0,		0,		0,		0,		6,		3}//video flat  
        },
        //speaker
        {
            //music
        //slc_enable    input_level depth       geq_nband   band1       band2       band3       band4       band5       band6       band7       nb_cf       nb_ol            
            ...
            {1,		1,		1,		7,		0,		0,		0,		0,		0,		0,		0,		20,     3},//music default
