...
private:
   /* typedef unsigned __int16 uint16_t;
    ...
    static const /*uint8_t*/int  sm_leapMonth[YEAR_NUM];       // 每年的闰月月份
    static const /*uint16_t*/int sm_monthDay[YEAR_NUM];        // 每年的所有月的月天数
    static const /*uint8_t*/int  sm_solarTerm[YEAR_NUM][12];   // 每年的二十四节气数据
...
public:
    ...
    */
    static int GetYearDays(int year)
    {
        ...
        /*uint16_t*/int num = sm_monthDay[year - YEAR_BASE];
    ...
    */
    static int GetSolarTerm(int year, int index) 
    {
        ...
        --index;  // 把取值范围转换为[0, 23]
        /*uint8_t*/ int data = sm_solarTerm[year - YEAR_BASE][index / 2];
