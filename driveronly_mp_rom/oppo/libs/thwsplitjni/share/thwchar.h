 ...
 */
typedef unsigned short thwchar_t;
 ...
 */
extern int th_tis2uni_line(thchar_t* s, thwchar_t* result, size_t n);
 ...
 */
extern int th_uni2tis_line(thwchar_t* s, thchar_t* result, int n);
