 ...
 */
extern int th_wbrk( thwchar_t *s, int pos[], int n);
 ...
 */
extern int th_wbrk_line( thwchar_t *in, thwchar_t *out, int n,
                         thwchar_t *delim);
extern U8 get_break_pos(U8* in);
extern int th_wbrk(thwchar_t *s, int pos[], int n);
extern int IsThaiLang(U8* in);
extern int ThaiCurrentLineSplit(U8* in, U8* out);
extern int ThaiNextLineSplit(U8* in, U8* out, int index);
#endif  /* THAI_THWBRK_H */
