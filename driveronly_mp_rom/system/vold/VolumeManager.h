...
public:
    ...
    //To solve APP2SD JE issue in SD-SWAP
	...
	void set2SdcardSwapped(bool isSwapped) {		
		...
		if(mIs2sdSwapped) {
		#ifndef VENDOR_EDIT
		//LinJie.Xu@Prd.SysSrv.USB, 2013/01/09, Modify for OPPO_CASECADE_MOUNT
		/*
		...
		*/
		   	...
		   	property_set("external_sd_path", "/storage/sdcard0");
		    property_set("internal_sd_path", "/storage/sdcard0/external_sd");
		   #else
		    property_set("internal_sd_path", "/storage/sdcard1");
			property_set("external_sd_path", "/storage/sdcard0");
		   #endif
		...
		*/
		#else /* VENDOR_EDIT */
		   #ifdef OPPO_EMMC_DYNAMICMOUNT_SUPPORT
		   	property_set("external_sd_path", "/storage/sdcard0/external_sd");
		    property_set("internal_sd_path", "/storage/sdcard0");
		   #else /*OPPO_CASECADE_MOUNT*/
		    property_set("internal_sd_path", "/storage/sdcard0");
			property_set("external_sd_path", "/storage/sdcard1");
		   #endif
		#endif /* VENDOR_EDIT */
		...
		//linjie.xu=>this should change for meta?
		if(mIs2sdSwapped) 
